...
for _, entry in ipairs(result) do
    if entry.order then
        print(table.concat({"Customer", tostring(entry.customerName), "has order", tostring(entry.order.id), "- $", tostring(entry.order.total)}, ' '));
    else
        print(table.concat({"Customer", tostring(entry.customerName), "has no orders"}, ' '));
    end
end
