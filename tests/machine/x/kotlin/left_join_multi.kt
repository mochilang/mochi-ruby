// Generated by Mochi compiler v0.10.28 on 2025-07-18T07:11:29Z
...
data class Row0(var orderId: Int, var name: String, var item: Item)
    ...
    for (o in orders) {
        for (c in customers) {
            if (o.customerId == c.id) {
                for (i in items) {
                    if (o.id == i.orderId) {
                        __res.add(Row0(orderId = o.id, name = c.name, item = i))
                    }
                }
            }
        }
