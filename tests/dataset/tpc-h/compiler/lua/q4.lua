...
function test_Q4_returns_count_of_orders_with_late_lineitems_in_range()
    if not ((result == {{["o_orderpriority"]="1-URGENT", ["order_count"]=1}, {["o_orderpriority"]="2-HIGH", ["order_count"]=1}})) then error('expect failed') end
end
...
late_orders = (function()
    ...
    for _, l in ipairs(lineitem) do
        if ((l.l_orderkey == o.o_orderkey) and (l.l_commitdate < l.l_receiptdate)) then
            _res[#_res+1] = l
        end
    end
    return _res
