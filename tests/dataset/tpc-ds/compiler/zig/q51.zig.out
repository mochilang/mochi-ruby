...
fn test_TPCDS_Q51_placeholder() void {
    expect((result == @as(i32,@intCast(51))));
}

pub fn main() void {
    t = &[_]std.AutoHashMap([]const u8, i32){blk0: { var m = std.AutoHashMap(i32, i32).init(std.heap.page_allocator); m.put("id", @as(i32,@intCast(1))) catch unreachable; m.put("val", @as(i32,@intCast(51))) catch unreachable; break :blk0 m; }};
