...
var customer = [Customer(c_customer_sk: 1, c_customer_id: "C1", c_first_name: "John", c_last_name: "Doe")]
var store_sales = [StoreSale(ss_customer_sk: 1, ss_sold_date_sk: 1998, ss_ext_list_price: 60.0), StoreSale(ss_customer_sk: 1, ss_sold_date_sk: 1999, ss_ext_list_price: 90.0)]
var web_sales = [WebSale(ws_bill_customer_sk: 1, ws_sold_date_sk: 1998, ws_ext_list_price: 50.0), WebSale(ws_bill_customer_sk: 1, ws_sold_date_sk: 1999, ws_ext_list_price: 150.0)]
...
let result = growth_ok ? [Auto4(customer_first_name: "John", customer_id: "C1", customer_last_name: "Doe")] : []
_json(result)
