...
var store_sales = [StoreSale(ss_sold_time_sk: 1, ss_hdemo_sk: 1, ss_store_sk: 1), StoreSale(ss_sold_time_sk: 1, ss_hdemo_sk: 1, ss_store_sk: 1), StoreSale(ss_sold_time_sk: 2, ss_hdemo_sk: 1, ss_store_sk: 1)]
var household_demographics = [HouseholdDemographic(hd_demo_sk: 1, hd_dep_count: 3)]
var time_dim = [TimeDim(t_time_sk: 1, t_hour: 20, t_minute: 35), TimeDim(t_time_sk: 2, t_hour: 20, t_minute: 45)]
var store = [Store(s_store_sk: 1, s_store_name: "ese")]
let result = ({
	var _res: [StoreSale] = []
