...
var web_returns = [WebReturn(cash: 20.0, fee: 1.0, qty: 60), WebReturn(cash: 30.0, fee: 2.0, qty: 100), WebReturn(cash: 25.0, fee: 3.0, qty: 95)]
let result = _avg(web_returns.map { r in r.qty })
_json(result)
expect(_equal(result, 85.0))
