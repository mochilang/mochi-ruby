...
var item = [Item(id: 1), Item(id: 2), Item(id: 3)]
var inventory = [Inventory(item: 1, qty: 20), Inventory(item: 1, qty: 22), Inventory(item: 1, qty: 5), Inventory(item: 2, qty: 30), Inventory(item: 2, qty: 5), Inventory(item: 3, qty: 10)]
var store_sales = [StoreSale(item: 1), StoreSale(item: 2)]
var result = 0
