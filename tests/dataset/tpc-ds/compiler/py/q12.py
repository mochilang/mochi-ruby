# Generated by Mochi compiler v0.10.27 on 2025-07-17T17:49:41Z
...
def test_TPCDS_Q12_revenue_ratio():
    assert result == [
        Auto1(
            i_item_id="ITEM1",
...
web_sales = [
    WebSale(ws_item_sk=1, ws_sold_date_sk=1, ws_ext_sales_price=100.0),
    WebSale(ws_item_sk=1, ws_sold_date_sk=2, ws_ext_sales_price=100.0),
    WebSale(ws_item_sk=2, ws_sold_date_sk=2, ws_ext_sales_price=200.0),
    WebSale(ws_item_sk=3, ws_sold_date_sk=3, ws_ext_sales_price=50.0),
]
item = [
    Item(
        i_item_sk=1,
...
date_dim = [
    DateDim(d_date_sk=1, d_date="2001-01-20"),
    DateDim(d_date_sk=2, d_date="2001-02-05"),
    DateDim(d_date_sk=3, d_date="2001-03-05"),
]
