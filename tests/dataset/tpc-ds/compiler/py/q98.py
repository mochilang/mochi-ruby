# Generated by Mochi compiler v0.10.27 on 2025-07-17T17:51:22Z
...
store_sales = [
    StoreSale(ss_item_sk=1, ss_sold_date_sk=1, ss_ext_sales_price=50.0),
    StoreSale(ss_item_sk=2, ss_sold_date_sk=1, ss_ext_sales_price=100.0),
]
item = [
    Item(
        i_item_sk=1,
...
date_dim = [DateDim(d_date_sk=1, d_date="2000-02-01")]
...
result = _query(
    grouped,
    [{"items": totals, "on": lambda g, t: g.i_class == t._class}],
    {
        "select": lambda g, t: Auto1(
        ...
        "sortKey": lambda g, t: [g.i_category, g.i_class, g.i_item_id],
    },
)
