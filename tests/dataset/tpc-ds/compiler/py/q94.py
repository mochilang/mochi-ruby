# Generated by Mochi compiler v0.10.27 on 2025-07-17T17:51:17Z
...
web_returns = [WebReturn(wr_order_number=2)]
        ...
        "where": lambda ws, d, ca, w: (
            ...
            and len(
                [
                    ...
                    and ws.ws_warehouse_sk != ws2.ws_warehouse_sk
                ]
            )
            > 0
        )
        and (
            len([wr for wr in web_returns if wr.wr_order_number == ws.ws_order_number])
            > 0
        )
        == False,
    },
