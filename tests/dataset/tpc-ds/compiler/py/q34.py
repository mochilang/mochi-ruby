# Generated by Mochi compiler v0.10.27 on 2025-07-17T17:50:02Z
...
date_dim = [DateDim(d_date_sk=1, d_dom=2, d_year=2000)]
...
result = _query(
    dn,
    [{"items": customer, "on": lambda dn1, c: dn1.ss_customer_sk == c.c_customer_sk}],
    {
        "select": lambda dn1, c: Auto1(
        ...
        "where": lambda dn1, c: dn1.cnt >= 15 and dn1.cnt <= 20,
        "sortKey": lambda dn1, c: c.c_last_name,
    },
)
