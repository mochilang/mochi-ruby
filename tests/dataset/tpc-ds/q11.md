...
This query comes from the TPC-DS specification. The example implementation in
[q11.mochi](./q11.mochi) compares year-over-year sales for a single customer and
returns those with greater growth on the web channel.
...
## Expected Output
The dataset yields one customer meeting the growth condition.
```json
[
