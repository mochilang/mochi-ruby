...
company_name = [Map.fromList [("id", (1 :: Int)), ("country_code", "[de]")], Map.fromList [("id", (2 :: Int)), ("country_code", "[us]")]]

keyword = [Map.fromList [("id", (1 :: Int)), ("keyword", "character-name-in-title")], Map.fromList [("id", (2 :: Int)), ("keyword", "other")]]

movie_companies = [Map.fromList [("movie_id", (100 :: Int)), ("company_id", (1 :: Int))], Map.fromList [("movie_id", (200 :: Int)), ("company_id", (2 :: Int))]]

movie_keyword = [Map.fromList [("movie_id", (100 :: Int)), ("keyword_id", (1 :: Int))], Map.fromList [("movie_id", (200 :: Int)), ("keyword_id", (2 :: Int))]]

title = [Map.fromList [("id", (100 :: Int)), ("title", "Der Film")], Map.fromList [("id", (200 :: Int)), ("title", "Other Movie")]]
