...
fn exp(x_2: f64) f64 {
    ...
    n = n;
    while (n < 20) {
        term_1 = term_1 * x_2 / @as(f64, @floatFromInt(n));
        sum_1 = sum_1 + term_1;
        n = n +% 1;
    }
    return sum_1;
...
fn pow_float(base: f64, exponent: f64) f64 {
    return exp(exponent * ln(base));
}

fn get_altitude_at_pressure(pressure: f64) f64 {
    ...
    const ratio: f64 = pressure / 101325.0;
...
pub fn main() void {
    {
        ...
        std.debug.print("{s}\n", .{_str(get_altitude_at_pressure(100000.0))});
        std.debug.print("{s}\n", .{_str(get_altitude_at_pressure(101325.0))});
        std.debug.print("{s}\n", .{_str(get_altitude_at_pressure(80000.0))});
        const __end = _now();
