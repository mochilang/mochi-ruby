...
fn centripetal(mass: f64, velocity: f64, radius: f64) f64 {
    if (mass < 0.0) {
...
fn round(x_1: f64, n_1: i64) f64 {
    ...
    return floor(x_1 * m + 0.5) / m;
}

fn show(mass_1: f64, velocity_1: f64, radius_1: f64) void {
    const f: f64 = centripetal(mass_1, velocity_1, radius_1);
    std.debug.print("{s}\n", .{_str(round(f, 2))});
}
...
pub fn main() void {
    {
        ...
        show(15.5, @as(f64, @floatFromInt(0)) - 30.0, 10.0);
        show(10.0, 15.0, 5.0);
        show(20.0, @as(f64, @floatFromInt(0)) - 50.0, 15.0);
