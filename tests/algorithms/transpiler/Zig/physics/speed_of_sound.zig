...
fn speed_of_sound_in_a_fluid(density: f64, bulk_modulus: f64) f64 {
    if (density <= 0.0) {
...
pub fn main() void {
    {
        ...
        std.debug.print("{s}\n", .{_str(speed_of_sound_in_a_fluid(998.0, 2150000000.0))});
        std.debug.print("{s}\n", .{_str(speed_of_sound_in_a_fluid(13600.0, 28500000000.0))});
        const __end = _now();
