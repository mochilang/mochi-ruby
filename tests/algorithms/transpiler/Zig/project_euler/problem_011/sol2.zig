...
fn max_product_four(grid_param: [][]i64) i64 {
    ...
    while (i < 20) {
        ...
        j = j;
        while (j < 17) {
            const temp: i64 = grid_param[_idx(grid_param.len, i)][_idx(grid_param[_idx(grid_param.len, i)].len, j)] *% grid_param[_idx(grid_param.len, i)][_idx(grid_param[_idx(grid_param.len, i)].len, j +% 1)] *% grid_param[_idx(grid_param.len, i)][_idx(grid_param[_idx(grid_param.len, i)].len, j +% 2)] *% grid_param[_idx(grid_param.len, i)][_idx(grid_param[_idx(grid_param.len, i)].len, j +% 3)];
            if (temp > maximum) {
                maximum = temp;
            }
            j = j +% 1;
    ...
    while (i < 17) {
        ...
        j_1 = j_1;
        while (j_1 < 20) {
            const temp_1: i64 = grid_param[_idx(grid_param.len, i)][_idx(grid_param[_idx(grid_param.len, i)].len, j_1)] *% grid_param[_idx(grid_param.len, i +% 1)][_idx(grid_param[_idx(grid_param.len, i +% 1)].len, j_1)] *% grid_param[_idx(grid_param.len, i +% 2)][_idx(grid_param[_idx(grid_param.len, i +% 2)].len, j_1)] *% grid_param[_idx(grid_param.len, i +% 3)][_idx(grid_param[_idx(grid_param.len, i +% 3)].len, j_1)];
            if (temp_1 > maximum) {
                maximum = temp_1;
            }
            j_1 = j_1 +% 1;
    ...
    while (i < 17) {
        ...
        j_2 = j_2;
        while (j_2 < 17) {
            const temp_2: i64 = grid_param[_idx(grid_param.len, i)][_idx(grid_param[_idx(grid_param.len, i)].len, j_2)] *% grid_param[_idx(grid_param.len, i +% 1)][_idx(grid_param[_idx(grid_param.len, i +% 1)].len, j_2 +% 1)] *% grid_param[_idx(grid_param.len, i +% 2)][_idx(grid_param[_idx(grid_param.len, i +% 2)].len, j_2 +% 2)] *% grid_param[_idx(grid_param.len, i +% 3)][_idx(grid_param[_idx(grid_param.len, i +% 3)].len, j_2 +% 3)];
            if (temp_2 > maximum) {
                maximum = temp_2;
            }
            j_2 = j_2 +% 1;
    ...
    while (i < 17) {
        ...
        j_3 = j_3;
        while (j_3 < 20) {
            const temp_3: i64 = grid_param[_idx(grid_param.len, i)][_idx(grid_param[_idx(grid_param.len, i)].len, j_3)] *% grid_param[_idx(grid_param.len, i +% 1)][_idx(grid_param[_idx(grid_param.len, i +% 1)].len, j_3 -% 1)] *% grid_param[_idx(grid_param.len, i +% 2)][_idx(grid_param[_idx(grid_param.len, i +% 2)].len, j_3 -% 2)] *% grid_param[_idx(grid_param.len, i +% 3)][_idx(grid_param[_idx(grid_param.len, i +% 3)].len, j_3 -% 3)];
            if (temp_3 > maximum) {
                maximum = temp_3;
            }
            j_3 = j_3 +% 1;
...
pub fn main() void {
    {
        ...
        std.debug.print("{s}\n", .{_str(max_product_four(grid_var))});
        const __end = _now();
