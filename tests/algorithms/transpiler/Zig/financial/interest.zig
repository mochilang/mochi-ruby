...
fn powf(base: f64, exp: f64) f64 {
    ...
    var i: i64 = 0;
    i = i;
    while (i < @as(i64, @intFromFloat(exp))) {
        result = result * base;
        i = i + 1;
    }
    return result;
...
fn simple_interest(principal: f64, daily_rate: f64, days: f64) f64 {
    if (days <= 0.0) {
...
fn compound_interest(principal: f64, nominal_rate: f64, periods: f64) f64 {
    if (periods <= 0.0) {
...
fn apr_interest(principal: f64, apr: f64, years: f64) f64 {
    if (years <= 0.0) {
