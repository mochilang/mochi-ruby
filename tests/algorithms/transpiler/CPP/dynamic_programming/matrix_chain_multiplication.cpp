// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:44:25 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
int64_t matrix_chain_multiply(const std::vector<int64_t>& arr) {
    ...
    while ((i > int64_t(0))) {
        ...
        while ((j < n)) {
            if ((i == j)) {
                _index(_index(dp, i), j) = int64_t(0);
            } else {
                int64_t k = i;
                while ((k < j)) {
                    int64_t cost = ((_index(_index(dp, i), k) + _index(_index(dp, (k + int64_t(1))), j)) + ((_index(arr, (i - int64_t(1))) * _index(arr, k)) * _index(arr, j)));
    ...
    return _index(_index(dp, int64_t(1)), (n - int64_t(1)));
}
