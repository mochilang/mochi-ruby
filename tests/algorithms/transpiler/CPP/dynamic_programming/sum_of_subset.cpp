// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:45:51 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
bool is_sum_subset(const std::vector<int64_t>& arr, int64_t required_sum) {
    ...
    std::vector<std::vector<bool>> subset = create_bool_matrix(arr_len, required_sum);
    int64_t i = int64_t(0);
    while ((i <= arr_len)) {
        _index(_index(subset, i), int64_t(0)) = true;
        i = (i + int64_t(1));
    }
    int64_t j = int64_t(1);
    while ((j <= required_sum)) {
        _index(_index(subset, int64_t(0)), j) = false;
        j = (j + int64_t(1));
    }
    i = int64_t(1);
    while ((i <= arr_len)) {
        j = int64_t(1);
        while ((j <= required_sum)) {
            if ((_index(arr, (i - int64_t(1))) > j)) {
                _index(_index(subset, i), j) = _index(_index(subset, (i - int64_t(1))), j);
            }
            if ((_index(arr, (i - int64_t(1))) <= j)) {
                _index(_index(subset, i), j) = (_index(_index(subset, (i - int64_t(1))), j) || _index(_index(subset, (i - int64_t(1))), (j - _index(arr, (i - int64_t(1))))));
            }
            j = (j + int64_t(1));
        }
        i = (i + int64_t(1));
