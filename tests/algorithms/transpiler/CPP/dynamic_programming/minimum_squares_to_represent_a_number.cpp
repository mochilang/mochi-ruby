// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:45:08 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
int64_t minimum_squares_to_represent_a_number(int64_t number) {
    ...
    _index(answers, int64_t(0)) = int64_t(0);
    int64_t i = int64_t(1);
    while ((i <= number)) {
        int64_t answer = i;
        ...
        int64_t j = int64_t(1);
        while ((j <= root)) {
            int64_t current_answer = (int64_t(1) + _index(answers, (i - (j * j))));
            if ((current_answer < answer)) {
                answer = current_answer;
            }
            j = (j + int64_t(1));
        }
        _index(answers, i) = answer;
        i = (i + int64_t(1));
    }
