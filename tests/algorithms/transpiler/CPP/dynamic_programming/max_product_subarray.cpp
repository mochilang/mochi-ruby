// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:44:38 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int64_t max_product_subarray(const std::vector<int64_t>& numbers) {
    ...
    int64_t max_till_now = _index(numbers, int64_t(0));
    int64_t min_till_now = _index(numbers, int64_t(0));
    int64_t max_prod = _index(numbers, int64_t(0));
    int64_t i = int64_t(1);
    while ((i < numbers.size())) {
        int64_t number = _index(numbers, i);
        if ((number < int64_t(0))) {
