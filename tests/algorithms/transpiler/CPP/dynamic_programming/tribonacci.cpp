// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:46:00 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::vector<int64_t> tribonacci(int64_t num) {
    ...
    while ((i < num)) {
        if (((i == int64_t(0)) || (i == int64_t(1)))) {
            ...
            int64_t t = ((_index(dp, (i - int64_t(1))) + _index(dp, (i - int64_t(2)))) + _index(dp, (i - int64_t(3))));
...
int main() {
    {
        ...
        { auto __tmp1 = tribonacci(int64_t(8)); std::cout << "["; for(size_t i=0;i<__tmp1.size();++i){ if(i>0) std::cout << ' '; std::cout << __tmp1[i]; } std::cout << "]"; }
        std::cout << std::endl;
    }
    return 0;
}
