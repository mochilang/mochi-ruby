// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:45:12 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
int64_t min_steps_to_one(int64_t number) {
    ...
    _index(table, int64_t(1)) = int64_t(0);
    int64_t i = int64_t(1);
    while ((i < number)) {
        _index(table, (i + int64_t(1))) = min_int(_index(table, (i + int64_t(1))), (_index(table, i) + int64_t(1)));
        if (((i * int64_t(2)) <= number)) {
            _index(table, (i * int64_t(2))) = min_int(_index(table, (i * int64_t(2))), (_index(table, i) + int64_t(1)));
        }
        if (((i * int64_t(3)) <= number)) {
            _index(table, (i * int64_t(3))) = min_int(_index(table, (i * int64_t(3))), (_index(table, i) + int64_t(1)));
        }
        i = (i + int64_t(1));
    }
