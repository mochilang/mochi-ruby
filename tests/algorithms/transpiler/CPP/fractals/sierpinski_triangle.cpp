// Generated by Mochi transpiler v0.10.73 on 2025-08-25 21:51:05 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
Point get_mid(const Point& p1, const Point& p2) {
    return Point{((p1.x + p2.x) / int64_t(2)), ((p1.y + p2.y) / int64_t(2))};
}
...
int main() {
    {
        ...
        triangle(Point{-int64_t(175), -int64_t(125)}, Point{int64_t(0), int64_t(175)}, Point{int64_t(175), -int64_t(125)}, int64_t(2));
    }
    return 0;
}
