// Generated by Mochi transpiler v0.10.73 on 2025-08-25 21:51:11 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::vector<std::string> vicsek(int64_t order) {
    ...
    int64_t size = prev.size();
    std::string blank = repeat_char(std::string(" "), size);
    std::vector<std::string> result = {};
    int64_t i = int64_t(0);
    while ((i < size)) {
        result = ([&]{ auto __tmp = result; __tmp.push_back(((blank + _index(prev, i)) + blank)); return __tmp; }());
        i = (i + int64_t(1));
    }
    i = int64_t(0);
    while ((i < size)) {
        result = ([&]{ auto __tmp = result; __tmp.push_back(((_index(prev, i) + _index(prev, i)) + _index(prev, i))); return __tmp; }());
        i = (i + int64_t(1));
    }
    i = int64_t(0);
    while ((i < size)) {
