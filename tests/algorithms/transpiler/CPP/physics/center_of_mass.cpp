// Generated by Mochi transpiler v0.10.73 on 2025-08-26 08:49:08 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <vector>
...
double round2(double x) {
    ...
    return ((double)(rounded) / (double)(100.0));
}
...
Coord3D center_of_mass(const std::vector<Particle>& ps) {
    ...
    double cm_x = round2(((double)(sum_x) / (double)(total_mass)));
    double cm_y = round2(((double)(sum_y) / (double)(total_mass)));
    double cm_z = round2(((double)(sum_z) / (double)(total_mass)));
...
int main() {
    {
        ...
        r1 = center_of_mass(std::vector<Particle>{Particle{1.5, 4.0, 3.4, 4.0}, Particle{5.0, 6.8, 7.0, 8.1}, Particle{9.4, 10.1, 11.6, 12.0}});
        std::cout << coord_to_string(r1);
        std::cout << std::endl;
        r2 = center_of_mass(std::vector<Particle>{Particle{1.0, 2.0, 3.0, 4.0}, Particle{5.0, 6.0, 7.0, 8.0}, Particle{9.0, 10.0, 11.0, 12.0}});
