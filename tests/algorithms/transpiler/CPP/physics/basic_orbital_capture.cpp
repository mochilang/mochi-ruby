// Generated by Mochi transpiler v0.10.73 on 2025-08-26 08:46:40 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
double capture_radii(double target_body_radius, double target_body_mass, double projectile_velocity) {
    ...
    double escape_velocity_squared = ((double)(((2.0 * G) * target_body_mass)) / (double)(target_body_radius));
    double denom = (projectile_velocity * projectile_velocity);
    double capture_radius = (target_body_radius * std::sqrt((1.0 + ((double)(escape_velocity_squared) / (double)(denom)))));
