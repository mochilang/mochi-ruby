// Generated by Mochi transpiler v0.10.73 on 2025-08-26 08:49:29 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
int main() {
    {
        ...
        { std::ostringstream __ss; double __dv = hubble_parameter(68.3, 0.0001, 0.3, 0.7, 0.0); if(__dv == 0) __dv = 0; if(std::floor(__dv) == __dv) { __ss<<std::fixed<<std::setprecision(1)<<__dv; } else { __ss<<std::defaultfloat<<std::setprecision(std::numeric_limits<double>::max_digits10)<<__dv; } std::cout << __ss.str(); }
        std::cout << std::endl;
    }
    return 0;
}
