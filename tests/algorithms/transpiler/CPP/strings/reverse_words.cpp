// Generated by Mochi transpiler v0.10.66 on 2025-08-14 19:13:46 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::string reverse_words(std::string input_str);
int main();
...
std::string reverse_words(std::string input_str) {
    ...
    int64_t i = (words.size() - int64_t(1));
    while ((i >= int64_t(0))) {
...
int main() {
    {
        ...
        std::cout << reverse_words(std::string("I love Python"));
        std::cout << std::endl;
        std::cout << reverse_words(std::string("I     Love          Python"));
        std::cout << std::endl;
    }
