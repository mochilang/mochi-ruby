// Generated by Mochi transpiler v0.10.66 on 2025-08-16 12:48:09 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <vector>
...
std::string root_str(const Complex& r) {
    if ((r.im == 0.0)) {
        return _to_string(r.re);
    }
    std::string s = _to_string(r.re);
    if ((r.im >= 0.0)) {
        s = (((s + std::string("+")) + _to_string(r.im)) + std::string("i"));
    } else {
        s = ((s + _to_string(r.im)) + std::string("i"));
    }
    return s;
}
