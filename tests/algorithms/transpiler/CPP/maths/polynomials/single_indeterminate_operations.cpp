// Generated by Mochi transpiler v0.10.66 on 2025-08-16 12:47:39 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
Polynomial add(const Polynomial& p, const Polynomial& q) {
    if ((p.degree > q.degree)) {
        ...
        int64_t i = int64_t(0);
        while ((i <= q.degree)) {
            coeffs[static_cast<size_t>(i)] = (_index(coeffs, i) + _index(q.coefficients, i));
            i = (i + int64_t(1));
        }
        ...
        int64_t i = int64_t(0);
        while ((i <= p.degree)) {
            coeffs[static_cast<size_t>(i)] = (_index(coeffs, i) + _index(p.coefficients, i));
            i = (i + int64_t(1));
        }
...
Polynomial mul(const Polynomial& p, const Polynomial& q) {
    ...
    while ((i <= p.degree)) {
        int64_t j = int64_t(0);
        while ((j <= q.degree)) {
            coeffs[static_cast<size_t>((i + j))] = (_index(coeffs, (i + j)) + (_index(p.coefficients, i) * _index(q.coefficients, j)));
            j = (j + int64_t(1));
        }
        i = (i + int64_t(1));
    }
...
std::string poly_to_string(const Polynomial& p) {
    ...
    while ((i >= int64_t(0))) {
        ...
        if ((coeff != 0.0)) {
            ...
            if ((i == int64_t(0))) {
                s = (s + _to_string(abs_coeff));
            } else             if ((i == int64_t(1))) {
                s = ((s + _to_string(abs_coeff)) + std::string("x"));
            } else {
                s = (((s + _to_string(abs_coeff)) + std::string("x^")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << i; return ss.str(); }()));
            }
