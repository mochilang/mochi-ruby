// Generated by Mochi transpiler v0.10.66 on 2025-08-16 12:48:03 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
std::string point_to_string(const Point& p) {
    return ((((((std::string("Point(") + _to_string(p.x)) + std::string(", ")) + _to_string(p.y)) + std::string(", ")) + _to_string(p.z)) + std::string(")"));
}
...
void test_distance() {
    ...
    std::cout << (((((std::string("Distance from ") + point_to_string(p1)) + std::string(" to ")) + point_to_string(p2)) + std::string(" is ")) + _to_string(d));
    std::cout << std::endl;
}
