// Generated by Mochi transpiler v0.10.73 on 2025-08-25 21:50:15 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int main() {
    {
        ...
        std::cout << (std::string("price_plus_tax(100, 0.25) = ") + _to_string(price_plus_tax(100.0, 0.25)));
        std::cout << std::endl;
        std::cout << (std::string("price_plus_tax(125.50, 0.05) = ") + _to_string(price_plus_tax(125.5, 0.05)));
        std::cout << std::endl;
    }
    return 0;
}
