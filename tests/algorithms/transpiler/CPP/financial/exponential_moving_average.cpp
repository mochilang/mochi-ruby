// Generated by Mochi transpiler v0.10.73 on 2025-08-25 21:49:23 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::vector<double> exponential_moving_average(const std::vector<double>& stock_prices, int64_t window_size) {
    ...
    double alpha = ((double)(2.0) / (double)((1.0 + (double)(window_size))));
    double moving_average = 0.0;
    std::vector<double> result = {};
    int64_t i = int64_t(0);
    while ((i < stock_prices.size())) {
        double price = _index(stock_prices, i);
        if ((i <= window_size)) {
            if ((i == int64_t(0))) {
