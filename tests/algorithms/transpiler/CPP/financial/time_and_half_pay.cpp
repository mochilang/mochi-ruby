// Generated by Mochi transpiler v0.10.73 on 2025-08-25 21:50:37 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
double pay(double hours_worked, double pay_rate, double hours) {
    ...
    double over_time_pay = ((double)((over_time * pay_rate)) / (double)(2.0));
...
int main() {
    {
        ...
        std::cout << _to_string(pay(41.0, 1.0, 40.0));
        std::cout << std::endl;
        std::cout << _to_string(pay(65.0, 19.0, 40.0));
        std::cout << std::endl;
        std::cout << _to_string(pay(10.0, 1.0, 40.0));
        std::cout << std::endl;
    }
    return 0;
}
