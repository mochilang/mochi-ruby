// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:35:54 GMT+7
...
cpp_int count_divisors(const cpp_int& n);
cpp_int solution();
int main();

cpp_int count_divisors(const cpp_int& n) {
    cpp_int m = n;
    cpp_int n_divisors = int64_t(1);
    cpp_int i = int64_t(2);
    while (((i * i) <= m)) {
        cpp_int multiplicity = int64_t(0);
        while (((m % i) == int64_t(0))) {
            m = (m / i);
