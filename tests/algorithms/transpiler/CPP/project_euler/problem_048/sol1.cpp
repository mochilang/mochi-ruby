// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:56:07 GMT+7
...
cpp_int pow_mod(const cpp_int& base, const cpp_int& exponent, const cpp_int& modulus);
std::string solution();
int main();
...
std::string solution() {
    cpp_int modulus = int64_t(10000000000);
