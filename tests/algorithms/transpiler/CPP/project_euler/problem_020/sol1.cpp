// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:47:28 GMT+7
...
cpp_int split_and_add(const cpp_int& number);
cpp_int solution(const cpp_int& num);
int main();

cpp_int factorial(const cpp_int& num) {
    cpp_int res = int64_t(1);
    cpp_int i = int64_t(2);
    while ((i <= num)) {
        res = (res * i);
        i = (i + int64_t(1));
