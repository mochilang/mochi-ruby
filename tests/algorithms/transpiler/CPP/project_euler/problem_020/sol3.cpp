// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:47:45 GMT+7
...
cpp_int digit_sum(const cpp_int& n);
cpp_int solution(const cpp_int& num);
int main();
...
cpp_int digit_sum(const cpp_int& n) {
    ...
    cpp_int i = int64_t(0);
    while ((i < s.size())) {
        std::string digit_str = ([&]{ std::string __s = s; long long __start = static_cast<long long>(i); long long __end = static_cast<long long>((i + int64_t(1))); if(__start < 0) __start = 0; if(__end < __start) __end = __start; if(__start > static_cast<long long>(__s.size())) __start = __s.size(); if(__end > static_cast<long long>(__s.size())) __end = __s.size(); return __s.substr(static_cast<size_t>(__start), static_cast<size_t>(__end - __start)); })();
