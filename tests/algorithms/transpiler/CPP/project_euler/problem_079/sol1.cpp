// Generated by Mochi transpiler v0.10.70 on 2025-08-23 14:43:01 GMT+7
...
cpp_int index_of(const std::vector<std::string>& xs, std::string c);
...
cpp_int find_secret_passcode(const std::vector<std::string>& logins);
int main();
...
cpp_int parse_int(std::string s) {
    ...
    cpp_int i = int64_t(0);
    while ((i < s.size())) {
        std::string c = std::string(1, s[static_cast<size_t>(i)]);
        value = ((value * int64_t(10)) + cpp_int(_parse_int_str(c, int64_t(10))));
        i = (i + int64_t(1));
    }
    return value;
}
...
std::vector<std::string> unique_chars(const std::vector<std::string>& logins) {
    ...
    cpp_int i = int64_t(0);
    while ((i < logins.size())) {
        std::string login = logins[static_cast<size_t>(i)];
        cpp_int j = int64_t(0);
        while ((j < login.size())) {
            std::string c = std::string(1, login[static_cast<size_t>(j)]);
            if (!contains(chars, c)) {
...
bool satisfies(const std::vector<std::string>& permutation, const std::vector<std::string>& logins) {
    ...
    while ((i < logins.size())) {
        std::string login = logins[static_cast<size_t>(i)];
        cpp_int i0 = index_of(permutation, std::string(1, login[static_cast<size_t>(int64_t(0))]));
        cpp_int i1 = index_of(permutation, std::string(1, login[static_cast<size_t>(int64_t(1))]));
        cpp_int i2 = index_of(permutation, std::string(1, login[static_cast<size_t>(int64_t(2))]));
        if (!((i0 < i1) && (i1 < i2))) {
            return false;
        }
        i = (i + int64_t(1));
...
std::string search(const std::vector<std::string>& chars, const std::vector<std::string>& current, const std::vector<std::string>& logins) {
    ...
    cpp_int i = int64_t(0);
    while ((i < chars.size())) {
        std::string c = chars[static_cast<size_t>(i)];
