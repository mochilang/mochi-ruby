// Generated by Mochi transpiler v0.10.71 on 2025-08-24 08:18:02 GMT+7
...
std::vector<cpp_int> DIGITS_FIFTH_POWER = std::vector<cpp_int>{cpp_int(0), cpp_int(1), cpp_int(32), cpp_int(243), cpp_int(1024), cpp_int(3125), cpp_int(7776), cpp_int(16807), cpp_int(32768), cpp_int(59049)};

cpp_int digits_fifth_powers_sum(const cpp_int& number) {
    cpp_int total = cpp_int(0);
    cpp_int n = number;
    while ((n > cpp_int(0))) {
        cpp_int digit = (n % cpp_int(10));
...
cpp_int solution() {
    cpp_int total = cpp_int(0);
    cpp_int num = cpp_int(1000);
    while ((num < cpp_int(1000000))) {
