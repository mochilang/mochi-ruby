// Generated by Mochi transpiler v0.10.70 on 2025-08-23 01:41:09 GMT+7
...
cpp_int sum_digits(const cpp_int& num);
cpp_int solution(const cpp_int& max_n);
int main();

cpp_int sum_digits(const cpp_int& num) {
    cpp_int n = num;
    cpp_int digit_sum = int64_t(0);
    while ((n > int64_t(0))) {
...
cpp_int solution(const cpp_int& max_n) {
    cpp_int pre_numerator = int64_t(1);
    cpp_int cur_numerator = int64_t(2);
    cpp_int i = int64_t(2);
    while ((i <= max_n)) {
        cpp_int temp = pre_numerator;
        cpp_int e_cont = int64_t(1);
