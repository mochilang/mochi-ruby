// Generated by Mochi transpiler v0.10.70 on 2025-08-23 13:49:40 GMT+7
...
bool is_palindrome(const cpp_int& n);
cpp_int sum_reverse(const cpp_int& n);
cpp_int solution(const cpp_int& limit);
int main();

std::string reverse_string(std::string s) {
    std::string result = std::string("");
    cpp_int i = (s.size() - int64_t(1));
    while ((i >= int64_t(0))) {
...
cpp_int solution(const cpp_int& limit) {
    ...
    cpp_int num = int64_t(1);
    while ((num < limit)) {
        cpp_int iterations = int64_t(0);
        cpp_int current = num;
