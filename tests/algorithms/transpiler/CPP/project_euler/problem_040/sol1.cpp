// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:54:08 GMT+7
...
cpp_int solution() {
    std::vector<cpp_int> targets = std::vector<cpp_int>{int64_t(1), int64_t(10), int64_t(100), int64_t(1000), int64_t(10000), int64_t(100000), int64_t(1000000)};
    cpp_int idx = int64_t(0);
    cpp_int product = int64_t(1);
    ...
    while ((idx < targets.size())) {
        ...
        while ((j < s.size())) {
            ...
            if ((count == targets[static_cast<size_t>(idx)])) {
                product = (product * cpp_int(([&](const auto& __s){ auto __i = j; if (__i < 0) __i += __s.size(); return __s[static_cast<size_t>(__i)]; })(s) - '0'));
                idx = (idx + int64_t(1));
                if ((idx == targets.size())) {
                    break;
                }
