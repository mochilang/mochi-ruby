// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:49:50 GMT+7
...
cpp_int fibonacci(const cpp_int& n);
cpp_int fibonacci_digits_index(const cpp_int& n);
...
cpp_int fibonacci_digits_index(const cpp_int& n) {
    cpp_int digits = int64_t(0);
    cpp_int index = int64_t(2);
    while ((digits < n)) {
        index = (index + int64_t(1));
        cpp_int fib = fibonacci(index);
