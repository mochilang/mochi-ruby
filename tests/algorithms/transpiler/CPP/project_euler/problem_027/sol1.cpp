// Generated by Mochi transpiler v0.10.71 on 2025-08-24 08:17:41 GMT+7
...
bool is_prime(const cpp_int& number) {
    if (((cpp_int(1) < number) && (number < cpp_int(4)))) {
        return true;
    } else     if ((((number < cpp_int(2)) || ((number % cpp_int(2)) == cpp_int(0))) || ((number % cpp_int(3)) == cpp_int(0)))) {
        return false;
    }

    cpp_int i = cpp_int(5);
    while (((i * i) <= number)) {
        if ((((number % i) == cpp_int(0)) || ((number % (i + cpp_int(2))) == cpp_int(0)))) {
            return false;
        }
        i = (i + cpp_int(6));
    }
...
cpp_int solution(const cpp_int& a_limit, const cpp_int& b_limit) {
    cpp_int longest_len = cpp_int(0);
    cpp_int longest_a = cpp_int(0);
    cpp_int longest_b = cpp_int(0);
    cpp_int a = ((-cpp_int(1) * a_limit) + cpp_int(1));
    while ((a < a_limit)) {
        cpp_int b = cpp_int(2);
        while ((b < b_limit)) {
            if (is_prime(b)) {
...
int main() {
    {
        ...
        std::cout << ([&]{ std::ostringstream ss; ss << std::boolalpha << solution(cpp_int(1000), cpp_int(1000)); return ss.str(); }());
        std::cout << std::endl;
    }
    return 0;
}
