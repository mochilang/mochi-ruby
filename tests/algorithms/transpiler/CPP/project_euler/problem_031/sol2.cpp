// Generated by Mochi transpiler v0.10.71 on 2025-08-24 08:18:15 GMT+7
...
cpp_int solution(const cpp_int& pence) {
    std::vector<cpp_int> coins = std::vector<cpp_int>{cpp_int(1), cpp_int(2), cpp_int(5), cpp_int(10), cpp_int(20), cpp_int(50), cpp_int(100), cpp_int(200)};
    std::vector<cpp_int> ways = {};
    cpp_int i = cpp_int(0);
    while ((i <= pence)) {
        ways = ([&]{ auto __tmp = ways; __tmp.push_back(cpp_int(0)); return __tmp; }());
        i = (i + cpp_int(1));
    }
    ways[static_cast<size_t>(cpp_int(0))] = cpp_int(1);
    cpp_int idx = cpp_int(0);
...
int main() {
    {
        ...
        std::cout << solution(cpp_int(500));
        std::cout << std::endl;
        std::cout << solution(cpp_int(200));
        std::cout << std::endl;
        std::cout << solution(cpp_int(50));
        std::cout << std::endl;
        std::cout << solution(cpp_int(10));
        std::cout << std::endl;
    }
    return 0;
}
