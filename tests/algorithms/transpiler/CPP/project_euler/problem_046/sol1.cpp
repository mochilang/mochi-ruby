// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:55:45 GMT+7
...
std::vector<cpp_int> compute_nums(const cpp_int& n);
cpp_int solution();
int main();
...
cpp_int solution() {
    return compute_nums(int64_t(1))[static_cast<size_t>(int64_t(0))];
}
