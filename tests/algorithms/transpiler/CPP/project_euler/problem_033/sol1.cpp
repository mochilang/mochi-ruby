// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:51:43 GMT+7
...
bool is_digit_cancelling(const cpp_int& num, const cpp_int& den);
std::vector<FractionPair> find_fractions();
cpp_int solution();
int main();

cpp_int gcd(const cpp_int& a, const cpp_int& b) {
    cpp_int x = ((a < int64_t(0)) ? -a : a);
    cpp_int y = ((b < int64_t(0)) ? -b : b);
    while ((y != int64_t(0))) {
        cpp_int t = (x % y);
        x = y;
        y = t;
...
bool is_digit_cancelling(const cpp_int& num, const cpp_int& den) {
    ...
    cpp_int num_unit = (num % int64_t(10));
    cpp_int num_tens = (num / int64_t(10));
    cpp_int den_unit = (den % int64_t(10));
    cpp_int den_tens = (den / int64_t(10));
...
std::vector<FractionPair> find_fractions() {
    ...
    cpp_int num = int64_t(10);
    while ((num < int64_t(100))) {
        cpp_int den = (num + int64_t(1));
...
cpp_int solution() {
    ...
    cpp_int num_prod = int64_t(1);
    cpp_int den_prod = int64_t(1);
    cpp_int i = int64_t(0);
    while ((i < fracs.size())) {
        FractionPair f = fracs[static_cast<size_t>(i)];
        num_prod = (num_prod * f.num);
        den_prod = (den_prod * f.den);
        i = (i + int64_t(1));
    }
    cpp_int g = gcd(num_prod, den_prod);
    return (den_prod / g);
}
