// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:46:17 GMT+7
...
cpp_int solution(const cpp_int& n) {
    std::vector<cpp_int> counters = std::vector<cpp_int>{};
    cpp_int i = int64_t(0);
    while ((i <= n)) {
    ...
    cpp_int largest_number = int64_t(1);
    cpp_int pre_counter = int64_t(1);
    cpp_int start = int64_t(2);
    while ((start < n)) {
        cpp_int number = start;
        cpp_int counter = int64_t(0);
        while (true) {
            if (((number < counters.size()) && (counters[static_cast<size_t>(number)] != int64_t(0)))) {
                counter = (counter + counters[static_cast<size_t>(number)]);
                break;
            }
        ...
        if (((start < counters.size()) && (counters[static_cast<size_t>(start)] == int64_t(0)))) {
