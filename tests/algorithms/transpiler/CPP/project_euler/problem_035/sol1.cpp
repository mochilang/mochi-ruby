// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:52:10 GMT+7
...
bool contains_an_even_digit(const cpp_int& n);
cpp_int parse_int(std::string s);
std::vector<cpp_int> find_circular_primes(const cpp_int& limit);
cpp_int solution();
int main();

cpp_int LIMIT = int64_t(10000);
std::vector<bool> sieve = {};
cpp_int i = int64_t(0);
cpp_int p = int64_t(2);

bool is_prime(const cpp_int& n) {
    return sieve[static_cast<size_t>(n)];
}
...
bool contains_an_even_digit(const cpp_int& n) {
    ...
    while ((idx < s.size())) {
        std::string c = std::string(1, s[static_cast<size_t>(idx)]);
...
cpp_int parse_int(std::string s) {
    ...
    cpp_int k = int64_t(0);
    while ((k < s.size())) {
        std::string ch = std::string(1, s[static_cast<size_t>(k)]);
        value = ((value * int64_t(10)) + cpp_int(_parse_int_str(ch, int64_t(10))));
        k = (k + int64_t(1));
    }
    return value;
}
...
std::vector<cpp_int> find_circular_primes(const cpp_int& limit) {
    std::vector<cpp_int> result = std::vector<cpp_int>{int64_t(2)};
    cpp_int num = int64_t(3);
    while ((num <= limit)) {
        if ((is_prime(num) && (contains_an_even_digit(num) == false))) {
            ...
            cpp_int j = int64_t(0);
            while ((j < s.size())) {
                std::string rotated_str = (([&]{ std::string __s = s; long long __start = static_cast<long long>(j); long long __end = s.size(); if(__start < 0) __start = 0; if(__end < __start) __end = __start; if(__start > static_cast<long long>(__s.size())) __start = __s.size(); if(__end > static_cast<long long>(__s.size())) __end = __s.size(); return __s.substr(static_cast<size_t>(__start), static_cast<size_t>(__end - __start)); })() + ([&]{ std::string __s = s; long long __start = static_cast<long long>(int64_t(0)); long long __end = static_cast<long long>(j); if(__start < 0) __start = 0; if(__end < __start) __end = __start; if(__start > static_cast<long long>(__s.size())) __start = __s.size(); if(__end > static_cast<long long>(__s.size())) __end = __s.size(); return __s.substr(static_cast<size_t>(__start), static_cast<size_t>(__end - __start)); })());
                cpp_int rotated = parse_int(rotated_str);
                if (!is_prime(rotated)) {
                    all_prime = false;
                    break;
                }
