// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:51:51 GMT+7
...
cpp_int sum_of_digit_factorial(const cpp_int& n);
cpp_int solution();
int main();

std::vector<cpp_int> DIGIT_FACTORIALS = std::vector<cpp_int>{int64_t(1), int64_t(1), int64_t(2), int64_t(6), int64_t(24), int64_t(120), int64_t(720), int64_t(5040), int64_t(40320), int64_t(362880)};

cpp_int sum_of_digit_factorial(const cpp_int& n) {
    if ((n == int64_t(0))) {
        return DIGIT_FACTORIALS[static_cast<size_t>(int64_t(0))];
    }
    cpp_int total = int64_t(0);
    cpp_int num = n;
    while ((num > int64_t(0))) {
        cpp_int digit = (num % int64_t(10));
        total = (total + DIGIT_FACTORIALS[static_cast<size_t>(digit)]);
        num = (num / int64_t(10));
    }
    return total;
}
...
cpp_int solution() {
    cpp_int limit = ((int64_t(7) * DIGIT_FACTORIALS[static_cast<size_t>(int64_t(9))]) + int64_t(1));
    cpp_int total = int64_t(0);
    cpp_int i = int64_t(3);
    while ((i < limit)) {
