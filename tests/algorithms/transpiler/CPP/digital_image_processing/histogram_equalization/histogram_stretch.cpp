// Generated by Mochi transpiler v0.10.72 on 2025-08-24 22:31:51 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::vector<std::vector<int64_t>> histogram_stretch(std::vector<std::vector<int64_t>>& image) {
    ...
    while ((i < height)) {
        int64_t j = int64_t(0);
        while ((j < width)) {
            int64_t val = _index(_index(image, i), j);
            _index(hist, val) = (_index(hist, val) + int64_t(1));
            j = (j + int64_t(1));
        }
        i = (i + int64_t(1));
    }
    ...
    int64_t h = int64_t(0);
    while ((h < int64_t(256))) {
        cumulative = (cumulative + _index(hist, h));
        _index(mapping, h) = ((int64_t(255) * cumulative) / total);
        h = (h + int64_t(1));
    }
    i = int64_t(0);
    while ((i < height)) {
        ...
        while ((j < width)) {
            int64_t val = _index(_index(image, i), j);
            _index(_index(image, i), j) = _index(mapping, val);
            j = (j + int64_t(1));
        }
        i = (i + int64_t(1));
    }
