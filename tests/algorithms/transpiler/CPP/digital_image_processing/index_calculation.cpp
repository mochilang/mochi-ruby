// Generated by Mochi transpiler v0.10.72 on 2025-08-24 22:31:56 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
double ccci(double red, double redEdge, double nir) {
    return ((double)(ndre(redEdge, nir)) / (double)(ndvi(red, nir)));
}
...
int main() {
    {
        ...
        double redEdge = 40.0;
        double nir = 100.0;
        std::cout << (std::string("NDVI=") + _to_string(ndvi(red, nir)));
        std::cout << std::endl;
        std::cout << (std::string("CCCI=") + _to_string(ccci(red, redEdge, nir)));
        std::cout << std::endl;
        std::cout << (std::string("CVI=") + _to_string(cvi(red, green, nir)));
        std::cout << std::endl;
    }
    return 0;
}
