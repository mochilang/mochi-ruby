// Generated by Mochi transpiler v0.10.72 on 2025-08-24 22:22:44 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
Stack empty_stack() {
    return Stack{std::vector<Node>{}, -int64_t(1)};
}
...
Stack push(const Stack& stack, std::string item) {
    Node new_node = Node{item, stack.top};
...
PopResult pop(const Stack& stack) {
    ...
    Node node = _index(stack.nodes, stack.top);
    int64_t new_top = node.next;
    Stack new_stack = Stack{stack.nodes, new_top};
