// Generated by Mochi transpiler v0.10.71 on 2025-08-23 15:36:34 GMT+7
import Foundation
import Dispatch
        ...
        while ((i < n)) {
            ...
            while ((j < ((n &- i) &- 1))) {
                if (((_idx(arr, j) as! String) > (_idx(arr, (j &+ 1)) as! String))) {
                    ...
                    arr = _set(arr, j, { let _tmp0 = (_idx(arr, (j &+ 1)) as! String); return _tmp0 }())
                    arr = _set(arr, (j &+ 1), { let _tmp1 = (temp as! String); return _tmp1 }())
                }
                j = _int((j &+ 1))
            }
            i = _int((i &+ 1))
