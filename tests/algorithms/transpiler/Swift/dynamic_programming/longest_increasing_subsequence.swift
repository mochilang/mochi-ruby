// Generated by Mochi transpiler v0.10.72 on 2025-08-25 08:40:05 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    do {
        assert({ let _tmp1 = (longest_subsequence(({
            var _arr: [Int] = []
        ...
        assert({ let _tmp3 = (longest_subsequence(({
            var _arr: [Int] = []
            _arr = _append(_arr, 4)
            _arr = _append(_arr, 8)
            _arr = _append(_arr, 7)
        ...
        assert({ let _tmp5 = (longest_subsequence(({
            var _arr: [Int] = []
        ...
        assert({ let _tmp7 = (longest_subsequence(({
            var _arr: [Int] = []
            _arr = _append(_arr, 9)
            _arr = _append(_arr, 8)
            _arr = _append(_arr, 7)
            ...
            _arr = _append(_arr, 7)
            return _arr
        }() as! [Int])) as! [Int]); let _tmp8 = ({
            var _arr: [Int] = []
            _arr = _append(_arr, 5)
            _arr = _append(_arr, 7)
            return _arr
        }() as! [Int]); return _tmp7 == _tmp8}())
        assert({ let _tmp9 = (longest_subsequence(({
            var _arr: [Int] = []
            _arr = _append(_arr, 1)
            _arr = _append(_arr, 1)
            _arr = _append(_arr, 1)
            return _arr
        }() as! [Int])) as! [Int]); let _tmp10 = ({
            var _arr: [Int] = []
            _arr = _append(_arr, 1)
            _arr = _append(_arr, 1)
            _arr = _append(_arr, 1)
