// Generated by Mochi transpiler v0.10.73 on 2025-08-25 22:32:32 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func sum_of_digits(_ n: Int) -> Int {
        ...
        while ((m > 0)) {
            ...
            m = _int(Int((Double(m) / Double(10)).rounded(.down)))
        }
        return res
    }
    func sum_of_digits_recursion(_ n: Int) -> Int {
        ...
        return (_int(((m % 10 + 10) % 10)) &+ _int(sum_of_digits_recursion(Int((Double(m) / Double(10)).rounded(.down)))))
    }
