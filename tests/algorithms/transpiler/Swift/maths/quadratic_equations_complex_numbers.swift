// Generated by Mochi transpiler v0.10.67 on 2025-08-17 12:19:16 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func div_real(_ a: Complex, _ r: Double) -> Complex {
        return Complex(re: _num((a.re / r)), im: _num((a.im / r)))
    }
    ...
    func sqrt_to_complex(_ d: Double) -> Complex {
        if ((d >= 0.0)) {
            return Complex(re: _num(sqrt_newton(_num(d))), im: 0.0)
        }
        return Complex(re: 0.0, im: _num(sqrt_newton(_num(-d))))
    }
    func quadratic_roots(_ a: Double, _ b: Double, _ c: Double) -> [Complex] {
        ...
        let sqrt_d = sqrt_to_complex(_num(delta))
        let minus_b = Complex(re: _num(-b), im: 0.0)
        let two_a = (2.0 * a)
        let root1 = div_real((add((minus_b as! Complex), (sqrt_d as! Complex)) as! Complex), _num(two_a))
        let root2 = div_real((sub((minus_b as! Complex), (sqrt_d as! Complex)) as! Complex), _num(two_a))
        return ({
            var _arr: [Complex] = []
