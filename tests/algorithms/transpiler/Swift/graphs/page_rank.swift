// Generated by Mochi transpiler v0.10.66 on 2025-08-15 15:25:23 GMT+7
import Foundation
import Dispatch
...
do {
    ...
    func node_to_string(_ n: Node) -> String {
        return ((_p((_p((_p((_p((_p((_p("<node=") + _p(n.name))) + _p(" inbound="))) + _p(n.inbound))) + _p(" outbound="))) + _p(n.outbound))) + _p(">")) as! String)
    }
    func page_rank(_ nodes: [Node], _ limit: Int, _ d: Double) -> [String: Double] {
        ...
        var i = 0
        while (i < limit) {
            print(_p((_p((_p("======= Iteration ") + _p(_p((i &+ 1))))) + _p(" ======="))))
            for n in nodes {
                var sum_val = 0.0
                for ib in n.inbound {
