public class Main {
    ...
    static int index_of_rightmost_set_bit(int number) {
        if (number < 0) {
    ...
    public static void main(String[] args) {
        System.out.println(_p(index_of_rightmost_set_bit(0)));
        System.out.println(_p(index_of_rightmost_set_bit(5)));
        System.out.println(_p(index_of_rightmost_set_bit(36)));
        System.out.println(_p(index_of_rightmost_set_bit(8)));
    }
