public class Main {
    ...
    static int find_unique_number(int[] arr) {
        if (arr.length == 0) {
    ...
    public static void main(String[] args) {
        System.out.println(_p(find_unique_number(((int[])(new int[]{1, 1, 2, 2, 3})))));
        System.out.println(_p(find_unique_number(((int[])(new int[]{4, 5, 4, 6, 6})))));
        System.out.println(_p(find_unique_number(((int[])(new int[]{7})))));
    }
