public class Main {
    ...
    static int card_value(String c) {
        if ((c.equals("2"))) {
            return 2;
        }
        if ((c.equals("3"))) {
...
arr[j + 1] = tmp;
    ...
    static int[] filter_not(int[] xs, int v) {
        int[] res = ((int[])(new int[]{}));
        for (int x : xs) {
            if (x != v) {
                res = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(res), java.util.stream.IntStream.of(x)).toArray()));
            }
        }
        return res;
    }

    static int[] hand_rank(String[] hand) {
        int[] ranks = ((int[])(new int[]{}));
        String[] suits = ((String[])(new String[]{}));
        for (String card : hand) {
            ranks = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(ranks), java.util.stream.IntStream.of(card_value(card.substring(0, 0+1)))).toArray()));
            suits = ((String[])(java.util.stream.Stream.concat(java.util.Arrays.stream(suits), java.util.stream.Stream.of(card.substring(1, 1+1))).toArray(String[]::new)));
        }
        ranks = ((int[])(sort_desc(((int[])(ranks)))));
        boolean flush = true;
        int i_1 = 1;
        while (i_1 < suits.length) {
            if (!(suits[i_1].equals(suits[0]))) {
                flush = false;
            }
            i_1 = i_1 + 1;
        }
        ...
        if (!straight && ranks[0] == 14 && ranks[1] == 5 && ranks[2] == 4 && ranks[3] == 3 && ranks[4] == 2) {
            straight = true;
            ranks = ((int[])(new int[]{5, 4, 3, 2, 1}));
        }
        java.util.Map<Integer,Integer> counts = ((java.util.Map<Integer,Integer>)(new java.util.LinkedHashMap<Integer, Integer>()));
        for (int r : ranks) {
            if (((Boolean)(counts.containsKey(r)))) {
counts.put(r, (int)(((int)(counts).getOrDefault(r, 0))) + 1);
            } else {
counts.put(r, 1);
            }
        }
        int[] uniq = ((int[])(new int[]{}));
        for (int r : ranks) {
            ...
            if (!exists) {
                uniq = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(uniq), java.util.stream.IntStream.of(r)).toArray()));
            }
        }
        int[][] count_vals = ((int[][])(new int[][]{}));
        for (int u : uniq) {
            count_vals = ((int[][])(appendObj(count_vals, new int[]{((int)(counts).getOrDefault(u, 0)), u})));
        }
        int n_1 = count_vals.length;
        int i2 = 0;
        while (i2 < n_1) {
            int j2 = 0;
            while (j2 < n_1 - 1) {
                int[] a = ((int[])(count_vals[j2]));
                int[] b = ((int[])(count_vals[j2 + 1]));
                if (a[0] < b[0] || (a[0] == b[0] && a[1] < b[1])) {
                    int[] tmp_1 = ((int[])(count_vals[j2]));
count_vals[j2] = ((int[])(count_vals[j2 + 1]));
count_vals[j2 + 1] = ((int[])(tmp_1));
                }
                j2 = j2 + 1;
            }
            i2 = i2 + 1;
        ...
        if (straight && flush) {
            if (ranks[0] == 14) {
                rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(9)).toArray()));
                rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(14)).toArray()));
                return rank;
            }
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(8)).toArray()));
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(ranks[0])).toArray()));
            return rank;
        }
        if (c1 == 4) {
            int kicker = 0;
            ...
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(7)).toArray()));
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(v1)).toArray()));
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(kicker)).toArray()));
            return rank;
        }
        if (c1 == 3) {
            ...
            if (c2 == 2) {
                rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(6)).toArray()));
                rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(v1)).toArray()));
                rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(v2)).toArray()));
                return rank;
            }
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(3)).toArray()));
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(v1)).toArray()));
            for (int r : ranks) {
                if (r != v1) {
                    rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(r)).toArray()));
                }
            }
            return rank;
        }
        if (c1 == 2) {
            int c2_1 = count_vals[1][0];
            int v2_1 = count_vals[1][1];
            if (c2_1 == 2) {
                int high_pair = v1;
                int low_pair = v2_1;
                ...
                rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(2)).toArray()));
                rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(high_pair)).toArray()));
                rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(low_pair)).toArray()));
                rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(kicker_1)).toArray()));
                return rank;
            }
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(1)).toArray()));
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(v1)).toArray()));
            for (int r : ranks) {
                if (r != v1) {
                    rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(r)).toArray()));
        ...
        if (flush) {
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(5)).toArray()));
            for (int r : ranks) {
                rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(r)).toArray()));
            }
            return rank;
        ...
        if (straight) {
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(4)).toArray()));
            rank = ((int[])(java.util.stream.IntStream.concat(java.util.Arrays.stream(rank), java.util.stream.IntStream.of(ranks[0])).toArray()));
            return rank;
        }
    ...
    static int compare_hands(String[] h1, String[] h2) {
        int[] r1 = ((int[])(hand_rank(((String[])(h1)))));
        int[] r2 = ((int[])(hand_rank(((String[])(h2)))));
        int i_2 = 0;
        while (i_2 < r1.length && i_2 < r2.length) {
            if (r1[i_2] > r2[i_2]) {
                return 1;
            }
            if (r1[i_2] < r2[i_2]) {
