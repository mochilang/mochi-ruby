public class Main {
    static class Quote {
        ...
        String a;
        String h;
        Quote(String q, String a, String h) {
            this.q = q;
            this.a = a;
            this.h = h;
        }
        ...
        @Override public String toString() {
            return String.format("{'q': '%s', 'a': '%s', 'h': '%s'}", String.valueOf(q), String.valueOf(a), String.valueOf(h));
        }
    }

    static Quote[] response;

    static Quote[] quote_of_the_day() {
        return _fetch("https://zenquotes.io/api/today");
    }

    static Quote[] random_quotes() {
        return _fetch("https://zenquotes.io/api/random");
    }
    public static void main(String[] args) {
        response = ((Quote[])(random_quotes()));
        System.out.println(java.util.Arrays.toString(response));
    }
