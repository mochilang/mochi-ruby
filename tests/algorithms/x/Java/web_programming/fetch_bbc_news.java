public class Main {
    static class Article {
        ...
        @Override public String toString() {
            return String.format("{'title': '%s'}", String.valueOf(title));
        }
    }

    static class NewsResponse {
        Article[] articles;
        NewsResponse(Article[] articles) {
            this.articles = articles;
        }
        NewsResponse() {}
        @Override public String toString() {
            return String.format("{'articles': %s}", String.valueOf(articles));
        }
    }


    static void fetch_bbc_news(String api_key) {
        ...
        while (i < resp.articles.length) {
            ...
            System.out.println(_p(i + 1) + ".) " + article.title);
            i = i + 1;
        }
    }
    ...
    static NewsResponse _fetch_NewsResponse(String url) {
        return _cast(NewsResponse.class, _fetch(url));
    }
