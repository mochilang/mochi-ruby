public class Main {
    ...
    static String send_slack_message(String message_body, String slack_url) {
        java.util.Map<String,String> headers = ((java.util.Map<String,String>)(new java.util.LinkedHashMap<String, String>(java.util.Map.ofEntries(java.util.Map.entry("Content-Type", "application/json")))));
        String response = (String)(_fetch_string(((String)(slack_url))));
        if (!(response.equals("ok"))) {
            throw new RuntimeException(String.valueOf("Request to slack returned an error: " + response));
        }
        return response;
    }
    ...
    static string _fetch_string(String url) {
        return _cast(string.class, _fetch(url));
    }
}
