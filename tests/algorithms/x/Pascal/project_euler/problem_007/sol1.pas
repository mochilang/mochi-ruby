...
begin
  ...
  is_prime_limit := isqrt(is_prime_number);
  is_prime_i := 5;
  while is_prime_i <= is_prime_limit do begin
...
begin
  solution_count := 0;
  solution_number := 1;
  while (solution_count <> solution_nth) and (solution_number < 3) do begin
  solution_number := solution_number + 1;
  if is_prime(solution_number) then begin
  solution_count := solution_count + 1;
end;
end;
  while solution_count <> solution_nth do begin
