// Generated by Mochi 0.10.70 (commit 32918a9a49) on 2025-08-23 13:41 +0700
...
class Program {
    ...
    public static BigInteger pow_int(BigInteger base_0, BigInteger exp_1) {
    ...
    public static BigInteger digital_sum(BigInteger n_4) {
    ...
    public static BigInteger solution(BigInteger a_8, BigInteger b_9) {
        BigInteger max_sum_10 = 0;
        BigInteger base_11 = 0;
        while ((base_11 < a_8)) {
            BigInteger power_12 = 0;
            while ((power_12 < b_9)) {
                BigInteger value_13 = Program.pow_int(base_11, power_12);
                BigInteger ds_14 = Program.digital_sum(value_13);
                if ((ds_14 > max_sum_10)) {
                    max_sum_10 = ds_14;
                }
                power_12 = (power_12 + 1);
