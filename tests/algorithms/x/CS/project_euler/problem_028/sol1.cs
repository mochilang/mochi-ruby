...
class Program {
    ...
    public static long solution(long n_0) {
        long total_1 = 1;
        long i_2 = 1;
        long limit_3 = ((n_0 + 1) / 2);
        while ((i_2 < limit_3)) {
            long odd_4 = ((2 * i_2) + 1);
            long even_5 = (2 * i_2);
            total_1 = ((total_1 + ((4 * odd_4) * odd_4)) - (6 * even_5));
            i_2 = (i_2 + 1);
        };
        return total_1;
    }
    ...
    static void Main() {
        {
            var __memStart = _mem();
            var __start = _now();
            Console.WriteLine(Program._fmtTop(_fmtStr(Program.solution(1001))));
            Console.WriteLine(Program._fmtTop(_fmtStr(Program.solution(500))));
