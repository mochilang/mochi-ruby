...
class Program {
    ...
    public static long fibonacci(long n_0) {
        if ((n_0 == 1)) {
            return 0;
        };
        if ((n_0 == 2)) {
    ...
    public static long fibonacci_digits_index(long n_5) {
        long digits_6 = 0;
        long index_7 = 2;
        while ((digits_6 < n_5)) {
            index_7 = (index_7 + 1);
            long fib_8 = Program.fibonacci(index_7);
            digits_6 = _fmtStr(fib_8).Length;
        };
        return index_7;
    }

    public static long solution(long n_9) {
        return Program.fibonacci_digits_index(n_9);
    }

    public static void main() {
        long n_10 = _atoi(_input());
        Console.WriteLine(Program._fmtTop(Program.solution(n_10)));
    }
