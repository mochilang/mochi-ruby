...
class Program {
    ...
    public static long pow_mod(long base_0, long exponent_1, long modulus_2) {
        long result_3 = 1;
    ...
    public static string solution() {
        long modulus_6 = 10000000000L;
        long total_7 = 0;
        long i_8 = 1;
        while ((i_8 <= 1000)) {
            total_7 = _mod((total_7 + Program.pow_mod(i_8, i_8, modulus_6)), modulus_6);
            i_8 = (i_8 + 1);
        };
        string s_9 = _fmtStr(total_7);
        while ((s_9.Length < 10)) {
            s_9 = ("0" + s_9);
        };
        return s_9;
