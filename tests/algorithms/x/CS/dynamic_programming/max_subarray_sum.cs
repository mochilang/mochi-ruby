...
class Program {
    ...
    static double[] empty_10 = new double[]{};
    public static double max_subarray_sum(double[] nums_0, bool allow_empty_1) {
        ...
        if (allow_empty_1) {
            ...
            while ((i_4 < nums_0.Length)) {
                double num_5 = _idx(nums_0, (long)(i_4));
            ...
            max_sum_2 = _idx(nums_0, (long)(0));
            curr_sum_3 = _idx(nums_0, (long)(0));
            BigInteger i_7 = 1;
            while ((i_7 < nums_0.Length)) {
                double num_8 = _idx(nums_0, (long)(i_7));
