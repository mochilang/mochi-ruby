...
class Program {
    ...
    public static long dfs_skip(long[][] graph_0, bool[] visited_1, long skip_2, long at_3) {
        visited_1[(int)(at_3)] = true;
        long count_4 = 1;
        foreach (long to_5 in _idx(graph_0, at_3)) {
            if ((to_5 == skip_2)) {
                continue;
            }
            if ((_idx(visited_1, to_5) == false)) {
    ...
    public static long[] articulation_points(long[][] graph_6) {
        ...
        while ((v_9 < n_7)) {
            ...
            if ((reach_13 < (n_7 - 1))) {
                result_8 = ((Func<long[]>)(() => { var _tmp = result_8.ToList(); _tmp.Add(v_9); return _tmp.ToArray(); }))();
