...
class Program {
    ...
    public static void search_in_sorted_matrix(double[][] mat_0, BigInteger m_1, BigInteger n_2, double key_3) {
        BigInteger i_4 = (m_1 - 1);
        BigInteger j_5 = 0;
        while (((i_4 >= 0) && (j_5 < n_2))) {
            if ((key_3 == _idx(_idx(mat_0, (long)(i_4)), (long)(j_5)))) {
    ...
    public static void main() {
        ...
        Program.search_in_sorted_matrix(mat_6, mat_6.Length, _idx(mat_6, (long)(0)).Length, 5.0);
        Program.search_in_sorted_matrix(mat_6, mat_6.Length, _idx(mat_6, (long)(0)).Length, 21.0);
        ...
        Program.search_in_sorted_matrix(mat2_7, mat2_7.Length, _idx(mat2_7, (long)(0)).Length, 2.1);
        Program.search_in_sorted_matrix(mat2_7, mat2_7.Length, _idx(mat2_7, (long)(0)).Length, 2.2);
    }
