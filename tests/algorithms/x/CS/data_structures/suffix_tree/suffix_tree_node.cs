...
class Program {
    ...
    static SuffixTreeNode root_8 = Program.new_suffix_tree_node(new Dictionary<string, BigInteger>{{"a", 1}}, false, -1, -1, -1);
    static SuffixTreeNode leaf_9 = Program.new_suffix_tree_node(new Dictionary<string, BigInteger>{}, true, 0, 2, 0);
    static SuffixTreeNode[] nodes_10 = new SuffixTreeNode[]{root_8, leaf_9};
    static SuffixTreeNode root_check_11 = _idx(nodes_10, (long)(0));
    static SuffixTreeNode leaf_check_12 = _idx(nodes_10, (long)(1));
    public static SuffixTreeNode new_suffix_tree_node(Dictionary<string, BigInteger> children_0, bool is_end_of_string_1, BigInteger start_2, BigInteger end_3, BigInteger suffix_link_4) {
    ...
    public static SuffixTreeNode empty_suffix_tree_node() {
        return Program.new_suffix_tree_node(new Dictionary<string, BigInteger>{}, false, -1, -1, -1);
    }

    public static bool has_key(Dictionary<string, BigInteger> m_5, string k_6) {
