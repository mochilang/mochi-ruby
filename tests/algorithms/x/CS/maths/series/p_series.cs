...
class Program {
    ...
    public static string[] p_series(long nth_term_9, long power_10) {
        ...
        while ((i_12 <= nth_term_9)) {
            if ((i_12 == 1)) {
                series_11 = ((Func<string[]>)(() => { var _tmp = series_11.Cast<string>().ToList(); _tmp.Add("1"); return _tmp.ToArray(); }))();
            } else {
                series_11 = ((Func<string[]>)(() => { var _tmp = series_11.Cast<string>().ToList(); _tmp.Add(("1 / " + Program.pow_string(i_12, power_10))); return _tmp.ToArray(); }))();
            }
            i_12 = (i_12 + 1);
        };
        return series_11;
