...
class Program {
    ...
    public static double sum_of_harmonic_progression(double first_term_0, double common_difference_1, BigInteger number_of_terms_2) {
        ...
        while ((j_7 < arithmetic_progression_3.Length)) {
            total_6 = (total_6 + (1.0 / _idx(arithmetic_progression_3, (long)(j_7))));
            j_7 = (j_7 + 1);
        };
        return total_6;
    }
