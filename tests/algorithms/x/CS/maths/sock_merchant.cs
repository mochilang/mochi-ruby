...
class Program {
    ...
    public static long sock_merchant(long[] colors_0) {
        ...
        while ((i_2 < colors_0.Length)) {
            arr_1 = ((Func<long[]>)(() => { var _tmp = arr_1.Cast<long>().ToList(); _tmp.Add(_idx(colors_0, i_2)); return _tmp.ToArray(); }))();
            i_2 = (i_2 + 1);
        };
        ...
        while ((a_4 < n_3)) {
            ...
            long b_6 = (a_4 + 1);
            while ((b_6 < n_3)) {
                if ((_idx(arr_1, b_6) < _idx(arr_1, min_idx_5))) {
                    min_idx_5 = b_6;
                }
                b_6 = (b_6 + 1);
            }
            long temp_7 = _idx(arr_1, a_4);
            arr_1[(int)(a_4)] = _idx(arr_1, min_idx_5);
            arr_1[(int)(min_idx_5)] = temp_7;
            a_4 = (a_4 + 1);
        };
        long pairs_8 = 0;
        i_2 = 0;
        while ((i_2 < n_3)) {
            long count_9 = 1;
            while ((((i_2 + 1) < n_3) && (_idx(arr_1, i_2) == _idx(arr_1, (i_2 + 1))))) {
                count_9 = (count_9 + 1);
                i_2 = (i_2 + 1);
            }
            pairs_8 = (pairs_8 + _floordiv(count_9, 2));
            i_2 = (i_2 + 1);
        };
        return pairs_8;
    }
