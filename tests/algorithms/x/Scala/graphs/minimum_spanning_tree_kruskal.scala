// Generated by Mochi v0.10.66 on 2025-08-15 15:25:47 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(_str(edges_to_string(kruskal(BigInt(4), edges1))))
    println(_str(edges_to_string(kruskal(BigInt(4), edges2))))
    println(_str(edges_to_string(kruskal(BigInt(4), edges3))))
    val _end = _now()
    System.gc()
