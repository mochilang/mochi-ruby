// Generated by Mochi v0.10.71 on 2025-08-23 15:37:25 GMT+7
...
def max_product_four(grid: ArrayBuffer[ArrayBuffer[BigInt]]): BigInt = {
  ...
  while (i < BigInt(20)) {
    ...
    while (j < BigInt(17)) {
      var temp: BigInt = grid.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((j.toInt).toInt).getOrElse(BigInt(0)) * grid.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift(((j + BigInt(1)).toInt).toInt).getOrElse(BigInt(0)) * grid.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift(((j + BigInt(2)).toInt).toInt).getOrElse(BigInt(0)) * grid.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift(((j + BigInt(3)).toInt).toInt).getOrElse(BigInt(0))
      if (temp > maximum) {
        maximum = temp
      }
      j = j + BigInt(1)
  ...
  while (i < BigInt(17)) {
    var j: BigInt = BigInt(0)
    while (j < BigInt(20)) {
      var temp: BigInt = grid.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((j.toInt).toInt).getOrElse(BigInt(0)) * grid.lift(((i + BigInt(1)).toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((j.toInt).toInt).getOrElse(BigInt(0)) * grid.lift(((i + BigInt(2)).toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((j.toInt).toInt).getOrElse(BigInt(0)) * grid.lift(((i + BigInt(3)).toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((j.toInt).toInt).getOrElse(BigInt(0))
      if (temp > maximum) {
        maximum = temp
      }
      j = j + BigInt(1)
  ...
  while (i < BigInt(17)) {
    var j: BigInt = BigInt(0)
    while (j < BigInt(17)) {
      var temp: BigInt = grid.lift((i.toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift((j.toInt).toInt).getOrElse(BigInt(0)) * grid.lift(((i + BigInt(1)).toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift(((j + BigInt(1)).toInt).toInt).getOrElse(BigInt(0)) * grid.lift(((i + BigInt(2)).toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift(((j + BigInt(2)).toInt).toInt).getOrElse(BigInt(0)) * grid.lift(((i + BigInt(3)).toInt).toInt).getOrElse(ArrayBuffer[BigInt]()).lift(((j + BigInt(3)).toInt).toInt).getOrElse(BigInt(0))
      if (temp > maximum) {
        maximum = temp
      }
      j = j + BigInt(1)
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(_str(_str(max_product_four(grid))))
    val _end = _now()
    System.gc()
