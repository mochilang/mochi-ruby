// Generated by Mochi v0.10.67 on 2025-08-17 12:25:04 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    println(_str(p_series(BigInt(5), BigInt(2))))
    println(_str(p_series(BigInt(-5), BigInt(2))))
    println(_str(p_series(BigInt(5), BigInt(-2))))
    println(_str(p_series(BigInt(0), BigInt(0))))
    println(_str(p_series(BigInt(1), BigInt(1))))
    val _end = _now()
    System.gc()
