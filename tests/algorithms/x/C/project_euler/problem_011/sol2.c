...
long long max_product_four(long long * * grid, size_t grid_len, size_t* grid_lens, size_t grid_lens_len);
int main(void);
...
long long max_product_four(long long * * grid, size_t grid_len, size_t* grid_lens, size_t grid_lens_len) {
    ...
    while (i < 20LL) {
        long long j = 0LL;
        while (j < 17LL) {
            long long temp = ((grid[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? grid_lens[(int)(i)] + _mochi_idx : _mochi_idx;})] * grid[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j + 1LL; _mochi_idx < 0 ? grid_lens[(int)(i)] + _mochi_idx : _mochi_idx;})]) * grid[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j + 2LL; _mochi_idx < 0 ? grid_lens[(int)(i)] + _mochi_idx : _mochi_idx;})]) * grid[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j + 3LL; _mochi_idx < 0 ? grid_lens[(int)(i)] + _mochi_idx : _mochi_idx;})];
            if (temp > maximum) {
                maximum = temp;
            }
            j = j + 1LL;
    ...
    while (i < 17LL) {
        long long j = 0LL;
        while (j < 20LL) {
            long long temp = ((grid[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? grid_lens[(int)(i)] + _mochi_idx : _mochi_idx;})] * grid[(int)({long long _mochi_idx = i + 1LL; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? grid_lens[(int)(i + 1LL)] + _mochi_idx : _mochi_idx;})]) * grid[(int)({long long _mochi_idx = i + 2LL; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? grid_lens[(int)(i + 2LL)] + _mochi_idx : _mochi_idx;})]) * grid[(int)({long long _mochi_idx = i + 3LL; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? grid_lens[(int)(i + 3LL)] + _mochi_idx : _mochi_idx;})];
            if (temp > maximum) {
                maximum = temp;
            }
            j = j + 1LL;
    ...
    while (i < 17LL) {
        long long j = 0LL;
        while (j < 17LL) {
            long long temp = ((grid[(int)({long long _mochi_idx = i; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j; _mochi_idx < 0 ? grid_lens[(int)(i)] + _mochi_idx : _mochi_idx;})] * grid[(int)({long long _mochi_idx = i + 1LL; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j + 1LL; _mochi_idx < 0 ? grid_lens[(int)(i + 1LL)] + _mochi_idx : _mochi_idx;})]) * grid[(int)({long long _mochi_idx = i + 2LL; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j + 2LL; _mochi_idx < 0 ? grid_lens[(int)(i + 2LL)] + _mochi_idx : _mochi_idx;})]) * grid[(int)({long long _mochi_idx = i + 3LL; _mochi_idx < 0 ? grid_len + _mochi_idx : _mochi_idx;})][(int)({long long _mochi_idx = j + 3LL; _mochi_idx < 0 ? grid_lens[(int)(i + 3LL)] + _mochi_idx : _mochi_idx;})];
            if (temp > maximum) {
                maximum = temp;
            }
            j = j + 1LL;
...
int main(void) {
    {
        ...
        puts(str_int(max_product_four(grid, grid_len, grid_lens, grid_len)));
