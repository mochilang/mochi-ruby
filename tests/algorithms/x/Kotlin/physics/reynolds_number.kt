...
fun reynolds_number(density: Double, velocity: Double, diameter: Double, viscosity: Double): Double {
    if ((((density <= 0.0) || (diameter <= 0.0) as Boolean)) || (viscosity <= 0.0)) {
...
fun main() {
    run {
        ...
        println(reynolds_number(234.0, 0.0 - 4.5, 0.3, 0.44))
        System.gc()
        val _end = _now()
