...
fun wheatstone_solver(resistance_1: Double, resistance_2: Double, resistance_3: Double): Double {
    if ((((resistance_1 <= 0.0) || (resistance_2 <= 0.0) as Boolean)) || (resistance_3 <= 0.0)) {
