                                      ...
                                      begin (
                                        if (
                                          < (
                                           ...
                                           (
                                            list-ref-safe heap bigger_child
                                          )
                                        )
                                         (
                                          begin (
                                           ...
                                           (
                                            list-set-safe! heap bigger_child temp
                                          )
                                        )
                                         (
                                          void
              ...
              define (
               ...
               (
                let (
                  (
                    max_value (
                      list-ref-safe heap 1
                    )
                  )
                )
                 (
                  begin (
                    list-set-safe! heap 1 (
                      list-ref-safe heap size
                    )
                  )
                   (
                    set! size (
