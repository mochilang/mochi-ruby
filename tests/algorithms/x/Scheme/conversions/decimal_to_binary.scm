  ...
  let (
   ...
   (
    begin (
     ...
     (
      define (
        decimal_to_binary_recursive_helper n
      )
       (
        call/cc (
          lambda (
                  ...
                  let (
                   ...
                   (
                    begin (
                      ret4 (
                        string-append (
                          decimal_to_binary_recursive_helper div
                        )
                         (
                          to-str-space mod
                        )
           ...
           (
            begin (
              ...
              if (
               ...
               (
                begin (
                  ret5 (
                    string-append "-0b" (
                      decimal_to_binary_recursive_helper (
                        - num
                      )
                    )
                  )
             ...
             (
              ret5 (
                string-append "0b" (
                  decimal_to_binary_recursive_helper num
                )
              )
            )
          )
