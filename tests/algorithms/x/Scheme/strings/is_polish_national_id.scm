              ...
              let (
               ...
               (
                begin (
                  if (
                    or (
                      _lt input_int 10100000
                    )
                     (
                      _gt input_int 99923199999
                    )
                  )
                   (
                    begin (
     ...
     (
      _display (
        if (
          string? (
            to-str-space (
              is_polish_national_id "02150803629"
            )
          )
        )
         (
     ...
     (
      _display (
        if (
          string? (
            to-str-space (
              is_polish_national_id "02075503622"
            )
          )
        )
         (
     ...
     (
      _display (
        if (
          string? (
            to-str-space (
              is_polish_national_id "02070803621"
            )
          )
        )
         (
