...
(defn -main []
  (let [rt (Runtime/getRuntime)
    ...
    start (System/nanoTime)]
      ...
      (while (<= main_i 100000) (do (def ^:dynamic main_result (trapezoidal_area f (- 5.0) 5.0 main_i)) (println (str (str (str "with " (str main_i)) " steps: ") (str main_result))) (alter-var-root (var main_i) (constantly (* main_i 10)))))
      (System/gc)
