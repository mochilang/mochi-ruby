...
(let/ec _break (let loop ()
  (if (let ([__l divisor] [__r n]) (cond [(and (number? __l) (number? __r)) (<= __l __r)] [else (<= (int __l) (int __r))])) (begin
    (let/ec _cont
      ...
      (if (let ([__l candidate] [__r max_val]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (let ()
