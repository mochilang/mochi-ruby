...
(define (hex_digit n)
  (let/ec _return (begin
(if (let ([__l n] [__r 10]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
(_return (to-string n))
) (void))
...
(define sum_index 0)
(let/ec _break (let loop ()
  (if (let ([__l sum_index] [__r (let ([__l digit_pos_to_extract] [__r precision]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (define denominator (let ([__l (* 8 sum_index)] [__r denominator_addend]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
      (if (let ([__l sum_index] [__r digit_pos_to_extract]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
...
(define (bailey_borwein_plouffe digit_position precision)
  (let/ec _return (begin
(if (let ([__l digit_position] [__r 0]) (cond [(and (number? __l) (number? __r)) (<= __l __r)] [else (<= (int __l) (int __r))])) (let ()
(panic "Digit position must be a positive integer")
) (void))
(if (let ([__l precision] [__r 0]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
