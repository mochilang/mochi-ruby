...
(if (let ([__l length_] [__r 0]) (cond [(and (number? __l) (number? __r)) (<= __l __r)] [else (<= (int __l) (int __r))])) (let ()
(panic "Length must be a positive integer.")
) (void))
(define res (list))
(define n 0)
(let/ec _break (let loop ()
  (if (let ([__l n] [__r length_]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (set! res (append (or res (list)) (list (* n (- (* 2 n) 1)))))
