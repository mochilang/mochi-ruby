...
(if (or (or (let ([__l n] [__r 0]) (cond [(and (number? __l) (number? __r)) (<= __l __r)] [else (<= (int __l) (int __r))])) (equal? start_term_a 0.0)) (equal? common_ratio_r 0.0)) (let ()
(_return (list))
) (void))
(define series (list))
...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r n]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (set! series (append (or series (list)) (list current)))
