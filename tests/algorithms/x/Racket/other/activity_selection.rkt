...
(define n (cond [(not finish) 0] [(string? finish) (string-length finish)] [(vector? finish) (vector-length finish)] [(hash? finish) (hash-count finish)] [else (length finish)]))
(displayln (to-string "The following activities are selected:"))
(define i 0)
(define result "0,")
(define j 1)
...
(define start (vector 1 3 0 5 8 5))
(define finish (vector 2 4 6 7 9 9))
