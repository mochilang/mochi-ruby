...
(define (stooge arr i h)
  (let/ec _return (begin
(if (let ([__l i] [__r h]) (cond [(and (number? __l) (number? __r)) (>= __l __r)] [else (>= (int __l) (int __r))])) (let ()
(_return void)
) (void))
(if (let ([__l (if arr (if (hash? arr) (hash-ref arr i #f) (safe-index arr (int i))) #f)] [__r (if arr (if (hash? arr) (hash-ref arr h #f) (safe-index arr (int h))) #f)]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (let ()
(define tmp (if arr (if (hash? arr) (hash-ref arr i #f) (safe-index arr (int i))) #f))
(vector-set! arr (int i) (if arr (if (hash? arr) (hash-ref arr h #f) (safe-index arr (int h))) #f))
(vector-set! arr (int h) tmp)
) (void))
(if (let ([__l (let ([__l (- h i)] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r 2]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (let ()
(define t (int (floor (/ (let ([__l (- h i)] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 3))))
(stooge arr i (- h t))
(stooge arr (let ([__l i] [__r t]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) h)
(stooge arr i (- h t))
) (void))
))
)
(define (stooge_sort arr)
  (let/ec _return (begin
(stooge arr 0 (- (cond [(not arr) 0] [(string? arr) (string-length arr)] [(vector? arr) (vector-length arr)] [(hash? arr) (hash-count arr)] [else (length arr)]) 1))
(_return arr)
))
)
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (to-string (stooge_sort (vector 18 0 (- 7) (- 1) 2 2))))
    (void)
  ))
