...
(define (odd_even_transposition arr)
...
(let/ec _break (let loop ()
  (if (let ([__l pass] [__r n]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (define i (modulo pass 2))
      (let/ec _break (let loop ()
  (if (let ([__l i] [__r (- n 1)]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (if (let ([__l (if arr (if (hash? arr) (hash-ref arr (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) #f) (safe-index arr (int (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))) #f)] [__r (if arr (if (hash? arr) (hash-ref arr i #f) (safe-index arr (int i))) #f)]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
...
(vector-set! arr (int (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))) tmp)
    ...
    (loop)) (void))))
      (set! pass (let ([__l pass] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    )
    (loop)) (void))))
(_return arr)
))
...
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (to-string (odd_even_transposition (vector 5.0 4.0 3.0 2.0 1.0))))
(displayln (to-string (odd_even_transposition (vector 13.0 11.0 18.0 0.0 (- 1.0)))))
(displayln (to-string (odd_even_transposition (vector (- 0.1) 1.1 0.1 (- 2.9)))))
    (void)
  ))
