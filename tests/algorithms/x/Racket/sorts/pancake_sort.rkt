...
(let/ec _break (let loop ()
  (if (let ([__l start] [__r end]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (define temp (if arr (if (hash? arr) (hash-ref arr start #f) (safe-index arr (int start))) #f))
      (vector-set! arr (int start) (if arr (if (hash? arr) (hash-ref arr end #f) (safe-index arr (int end))) #f))
      (vector-set! arr (int end) temp)
...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r n]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (if (let ([__l (if arr (if (hash? arr) (hash-ref arr i #f) (safe-index arr (int i))) #f)] [__r (if arr (if (hash? arr) (hash-ref arr mi #f) (safe-index arr (int mi))) #f)]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (let ()
(set! mi i)
) (void))
...
(define (pancake_sort arr)
  (let/ec _return (begin
(define cur (cond [(not arr) 0] [(string? arr) (string-length arr)] [(vector? arr) (vector-length arr)] [(hash? arr) (hash-count arr)] [else (length arr)]))
(let/ec _break (let loop ()
  (if (let ([__l cur] [__r 1]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (begin
    (let/ec _cont
      (define mi (find_max_index arr cur))
      (set! arr (flip arr mi))
      (set! arr (flip arr (- cur 1)))
      (set! cur (- cur 1))
    )
    (loop)) (void))))
(_return arr)
...
(define (main)
  (let/ec _return (begin
(define data (vector 3 6 1 10 2))
(define sorted (pancake_sort data))
