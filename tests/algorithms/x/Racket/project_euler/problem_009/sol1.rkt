...
(let/ec _break (let loop ()
  ...
  (if (< c 500) (begin
    (let/ec _cont
      (if (and (equal? (let ([__l (let ([__l a] [__r b]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))] [__r c]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) 1000) (equal? (let ([__l (* a a)] [__r (* b b)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) (* c c))) (let ()
(_return (* (* a b) c))
) (void))
...
(let/ec _break (let loop ()
  ...
  (if (< b 400) (begin
    (let/ec _cont
      (define c (- (- 1000 a) b))
      (if (and (and (< a b) (< b c)) (equal? (let ([__l (* a a)] [__r (* b b)]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))) (* c c))) (let ()
(_return (* (* a b) c))
) (void))
      (set! b (let ([__l b] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    )
...
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (to-string (solution_fast)))
    (void)
  ))
