...
(if (let ([__l doubled] [__r 9]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (let ()
...
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (json-encode (is_luhn "79927398713")))
(displayln (json-encode (is_luhn "79927398714")))
    (void)
  ))
