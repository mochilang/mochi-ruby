...
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (to-string (escape_velocity 5.971999999999999e+24 6.370999999999999e+06)))
(displayln (to-string (escape_velocity 7.347999999999999e+22 1.7369999999999998e+06)))
(displayln (to-string (escape_velocity 1.8979999999999997e+27 6.991099999999999e+07)))
    (void)
  ))
