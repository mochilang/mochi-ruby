...
(define (rms_speed_of_molecule temperature molar_mass)
  (let/ec _return (begin
(if (let ([__l temperature] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
(panic "Temperature cannot be less than 0 K")
) (void))
(if (let ([__l molar_mass] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (<= __l __r)] [else (<= (int __l) (int __r))])) (let ()
...
(set! vrms (rms_speed_of_molecule 300.0 28.0))
