...
(define force_ (/ (* (* K q1) q2) (* radius radius)))
(_return force_)
))
)
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (to-string (format2 (coulombs_law 15.5 20.0 15.0))))
(displayln (to-string (format2 (coulombs_law 1.0 15.0 5.0))))
(displayln (to-string (format2 (coulombs_law 20.0 (- 50.0) 15.0))))
(displayln (to-string (format2 (coulombs_law (- 5.0) (- 8.0) 10.0))))
(displayln (to-string (format2 (coulombs_law 50.0 100.0 50.0))))
    (void)
  ))
