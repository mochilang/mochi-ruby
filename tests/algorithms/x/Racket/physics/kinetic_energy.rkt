...
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (to-string (kinetic_energy 10.0 10.0)))
(displayln (to-string (kinetic_energy 0.0 10.0)))
(displayln (to-string (kinetic_energy 10.0 0.0)))
(displayln (to-string (kinetic_energy 20.0 (- 20.0))))
(displayln (to-string (kinetic_energy 0.0 0.0)))
(displayln (to-string (kinetic_energy 2.0 2.0)))
(displayln (to-string (kinetic_energy 100.0 100.0)))
    (void)
  ))
