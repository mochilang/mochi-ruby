...
(define (reynolds_number density velocity diameter viscosity)
  (let/ec _return (begin
(if (or (or (let ([__l density] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (<= __l __r)] [else (<= (int __l) (int __r))])) (let ([__l diameter] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (<= __l __r)] [else (<= (int __l) (int __r))]))) (let ([__l viscosity] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (<= __l __r)] [else (<= (int __l) (int __r))]))) (let ()
