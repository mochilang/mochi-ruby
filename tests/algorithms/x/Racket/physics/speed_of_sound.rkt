...
(define (speed_of_sound_in_a_fluid density bulk_modulus)
  (let/ec _return (begin
(if (let ([__l density] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (<= __l __r)] [else (<= (int __l) (int __r))])) (let ()
(panic "Impossible fluid density")
) (void))
(if (let ([__l bulk_modulus] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (<= __l __r)] [else (<= (int __l) (int __r))])) (let ()
