...
(define (casimir_force force_ area distance)
  (let/ec _return (begin
(define zero_count 0)
(if (equal? force_ 0.0) (let ()
...
(if (let ([__l force_] [__r 0.0]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
...
(define (main)
  (let/ec _return (begin
(displayln (to-string (to-string (casimir_force 0.0 4.0 0.03))))
(displayln (to-string (to-string (casimir_force 2.635e-10 0.0023 0.0))))
(displayln (to-string (to-string (casimir_force 2.737e-18 0.0 0.0023746))))
))
)
