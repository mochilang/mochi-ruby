...
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (to-string (to-string (focal_length_of_lens 10.0 4.0))))
(displayln (to-string (to-string (focal_length_of_lens 2.7 5.8))))
(displayln (to-string (to-string (object_distance 10.0 40.0))))
(displayln (to-string (to-string (object_distance 6.2 1.5))))
(displayln (to-string (to-string (image_distance 50.0 40.0))))
(displayln (to-string (to-string (image_distance 5.3 7.9))))
    (void)
  ))
