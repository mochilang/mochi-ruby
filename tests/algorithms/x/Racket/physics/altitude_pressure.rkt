...
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (to-string (to-string (get_altitude_at_pressure 100000.0))))
(displayln (to-string (to-string (get_altitude_at_pressure 101325.0))))
(displayln (to-string (to-string (get_altitude_at_pressure 80000.0))))
    (void)
  ))
