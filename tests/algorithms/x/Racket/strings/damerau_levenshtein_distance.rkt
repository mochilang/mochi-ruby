...
(define len1 (cond [(not first_string) 0] [(string? first_string) (string-length first_string)] [(vector? first_string) (vector-length first_string)] [(hash? first_string) (hash-count first_string)] [else (length first_string)]))
(define len2 (cond [(not second_string) 0] [(string? second_string) (string-length second_string)] [(vector? second_string) (vector-length second_string)] [(hash? second_string) (hash-count second_string)] [else (length second_string)]))
(define dp_matrix (vector))
...
(set! dp_matrix (appendv (or dp_matrix (vector)) (vector row)))
      (set! _ (+ _ 1))
      (loop)))
))
...
(vector-set! row (int 0) i)
(vector-set! dp_matrix (int i) row)
      (set! i (+ i 1))
      (loop)))
))
...
(vector-set! first_row (int j) j)
      (set! j (+ j 1))
      (loop)))
))
(vector-set! dp_matrix (int 0) first_row)
...
(if (let ([__l insertion] [__r value]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
(set! value insertion)
) (void))
...
(if (let ([__l substitution] [__r value]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
(set! value substitution)
) (void))
(vector-set! row (int j) value)
(if (and (and (and (let ([__l i] [__r 1]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (let ([__l j] [__r 1]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))]))) (equal? (slice first_string (- i 1) i) (slice second_string (- j 2) (- j 1)))) (equal? (slice first_string (- i 2) (- i 1)) (slice second_string (- j 1) j))) (let ()
...
(if (let ([__l transposition] [__r (if row (if (hash? row) (hash-ref row j #f) (safe-index row (int j))) #f)]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (let ()
(vector-set! row (int j) transposition)
) (void))
) (void))
      (set! j (+ j 1))
      (loop)))
