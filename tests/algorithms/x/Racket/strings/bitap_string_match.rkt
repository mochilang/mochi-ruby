...
(if (let ([__l m] [__r (cond [(not text) 0] [(string? text) (string-length text)] [(vector? text) (vector-length text)] [(hash? text) (hash-count text)] [else (length text)])]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (let ()
(_return (- 1))
) (void))
(define limit (pow2 (let ([__l m] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
(define all_ones (- limit 1))
(define pattern_mask (vector))
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r 27]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (set! pattern_mask (appendv (or pattern_mask (vector)) (vector all_ones)))
      (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    )
    (loop)) (void))))
(set! i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r m]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      ...
      (vector-set! pattern_mask (int idx) (bit_and (if pattern_mask (if (hash? pattern_mask) (hash-ref pattern_mask idx #f) (safe-index pattern_mask (int idx))) #f) (- all_ones (pow2 i))))
      (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    )
    (loop)) (void))))
