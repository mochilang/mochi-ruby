...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not vowels) 0] [(string? vowels) (string-length vowels)] [(vector? vowels) (vector-length vowels)] [(hash? vowels) (hash-count vowels)] [else (length vowels)])]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
