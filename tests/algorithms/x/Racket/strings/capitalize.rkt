...
(define (capitalize sentence)
  (let/ec _return (begin
(if (equal? (cond [(not sentence) 0] [(string? sentence) (string-length sentence)] [(vector? sentence) (vector-length sentence)] [(hash? sentence) (hash-count sentence)] [else (length sentence)]) 0) (let ()
(_return "")
) (void))
...
(_return (let ([__l capital] [__r (slice sentence 1 (cond [(not sentence) 0] [(string? sentence) (string-length sentence)] [(vector? sentence) (vector-length sentence)] [(hash? sentence) (hash-count sentence)] [else (length sentence)]))]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
))
)
