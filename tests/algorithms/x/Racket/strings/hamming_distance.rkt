...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not a) 0] [(string? a) (string-length a)] [(hash? a) (hash-count a)] [else (length a)])]) (< (int __l) (int __r))) (begin
    (let/ec _cont
      (if (not (string=? (substring a i (+ i 1)) (substring b i (+ i 1)))) (let ()
...
(let* ([_start_mem (current-memory-use)] [_start (current-inexact-monotonic-milliseconds)])
  (let/ec _return (begin
(displayln (to-string (hamming_distance "python" "python")))
(displayln (to-string (hamming_distance "karolin" "kathrin")))
(displayln (to-string (hamming_distance "00000" "11111")))
    (void)
  ))
