// Generated by Mochi v0.10.70 on 2025-08-23 13:54:28 GMT+7

let vowels: string = "aeiouAEIOU";
function is_vowel(c: string): boolean {
  let i: number = 0;
  while ((i < _len(vowels))) {
    if ((vowels[(()=>{const _mochi_idx = i; return _mochi_idx < 0 ? vowels.length + _mochi_idx : _mochi_idx;})()] === c)) {
      return true;
    }
    i = (i + 1);
  }
...
function show(s: string) {
  console.log(_str(count_vowels(s)));
}
var _nowSeed = 0;
