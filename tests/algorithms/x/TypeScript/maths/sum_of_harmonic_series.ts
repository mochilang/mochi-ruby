// Generated by Mochi v0.10.67 on 2025-08-17 13:47:15 GMT+7
...
function sum_of_harmonic_progression(first_term: number, common_difference: number, number_of_terms: number): number {
  ...
  while ((j < _len(arithmetic_progression))) {
    total = (total + (1.0 / arithmetic_progression[(()=>{const _mochi_idx = j; return _mochi_idx < 0 ? arithmetic_progression.length + _mochi_idx : _mochi_idx;})()]));
    j = (j + 1);
  }
  return total;
}
