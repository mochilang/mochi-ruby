...
function pluperfect_number(n: number): boolean {
  ...
  while ((temp > 0)) {
    let rem: bigint = (temp % 10);
    digit_histogram[(()=>{const _mochi_idx = rem; return _mochi_idx < 0 ? digit_histogram.length + _mochi_idx : _mochi_idx;})()] = (digit_histogram[(()=>{const _mochi_idx = rem; return _mochi_idx < 0 ? digit_histogram.length + _mochi_idx : _mochi_idx;})()] + 1);
  ...
  i = 0;
  while ((i < 10)) {
    if ((digit_histogram[(()=>{const _mochi_idx = i; return _mochi_idx < 0 ? digit_histogram.length + _mochi_idx : _mochi_idx;})()] > 0)) {
      total = (total + (digit_histogram[(()=>{const _mochi_idx = i; return _mochi_idx < 0 ? digit_histogram.length + _mochi_idx : _mochi_idx;})()] * pow_int(i, digit_total)));
    }
    i = (i + 1);
  }
  return (total === n);
