...
def push(list_, value):
    res = [value]
    res = _concat(res, list_.data)
    return LinkedList(data=res)
def swap_nodes(list_, v1, v2):
    if v1 == v2:
        return list_
    idx1 = 0 - 1
    idx2 = 0 - 1
    ...
    while i < len(list_.data):
        if list_.data[i] == v1 and idx1 == 0 - 1:
            idx1 = i
        if list_.data[i] == v2 and idx2 == 0 - 1:
            idx2 = i
        i = i + 1
