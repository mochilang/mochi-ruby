...
elseif type(v) == 'boolean' then
  ...
  do
    ...
    function test_doppler_effect()
      if (not almost_equal(doppler_effect(100.0, 330.0, 10.0, 0.0), 103.03030303030303, 1e-07)) then
        _panic("test 1 failed")
      end
      if (not almost_equal(doppler_effect(100.0, 330.0, (-10.0), 0.0), 96.96969696969697, 1e-07)) then
        _panic("test 2 failed")
      end
      if (not almost_equal(doppler_effect(100.0, 330.0, 0.0, 10.0), 103.125, 1e-07)) then
        _panic("test 3 failed")
      end
      if (not almost_equal(doppler_effect(100.0, 330.0, 0.0, (-10.0)), 97.05882352941177, 1e-07)) then
        _panic("test 4 failed")
      end
      if (not almost_equal(doppler_effect(100.0, 330.0, 10.0, 10.0), 106.25, 1e-07)) then
        _panic("test 5 failed")
      end
      if (not almost_equal(doppler_effect(100.0, 330.0, (-10.0), (-10.0)), 94.11764705882354, 1e-07)) then
        _panic("test 6 failed")
      end
    end
    function main()
      test_doppler_effect()
      print((((type(doppler_effect(100.0, 330.0, 10.0, 0.0)) == "table")) and (
      (function(v)
      ...
      if type(x) == "table" then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(doppler_effect(100.0, 330.0, 10.0, 0.0))) or (doppler_effect(100.0, 330.0, 10.0, 0.0))))
      end
      main()
