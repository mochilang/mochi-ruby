...
do
  ...
  G = 9.80665
  print((((type(potential_energy(10.0, 10.0)) == "table")) and (
  (function(v)
  ...
  if type(x) == "table" then
    ...
    elseif type(x) == "number" then
      ...
      return encode(v)
    end)(potential_energy(10.0, 10.0))) or (potential_energy(10.0, 10.0))))
    print((((type(potential_energy(10.0, 5.0)) == "table")) and (
    (function(v)
    local function encode(x)
    if type(x) == "table" then
      if x.__name and x.__order then
      ...
      elseif type(x) == "number" then
        ...
        return encode(v)
      end)(potential_energy(10.0, 5.0))) or (potential_energy(10.0, 5.0))))
      print((((type(potential_energy(2.0, 8.0)) == "table")) and (
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        if x.__name and x.__order then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(potential_energy(2.0, 8.0))) or (potential_energy(2.0, 8.0))))
