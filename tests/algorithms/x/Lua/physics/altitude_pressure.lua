...
elseif type(v) == 'boolean' then
  ...
  do
    ...
    function get_altitude_at_pressure(pressure)
      ...
      local ratio = (pressure / 101325.0)
      return (44330.0 * (1.0 - pow_float(ratio, (1.0 / 5.5255))))
    end
    print((((type(_str(get_altitude_at_pressure(100000.0))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      elseif type(x) == "number" then
        ...
        return encode(v)
      end)(_str(get_altitude_at_pressure(100000.0)))) or (_str(get_altitude_at_pressure(100000.0)))))
      print((((type(_str(get_altitude_at_pressure(101325.0))) == "table")) and (
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        if x.__name and x.__order then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(_str(get_altitude_at_pressure(101325.0)))) or (_str(get_altitude_at_pressure(101325.0)))))
        print((((type(_str(get_altitude_at_pressure(80000.0))) == "table")) and (
        (function(v)
        local function encode(x)
        if type(x) == "table" then
          if x.__name and x.__order then
          ...
          elseif type(x) == "number" then
            ...
            return encode(v)
          end)(_str(get_altitude_at_pressure(80000.0)))) or (_str(get_altitude_at_pressure(80000.0)))))
