...
elseif type(v) == 'table' and (v[1] == nil or v[0] ~= nil) then
  ...
  elseif type(v) == 'boolean' then
    ...
    print((((type(("guess the number : " .. _str(last_numbers[(_len(last_numbers) - 1) + 1]))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      elseif type(x) == "number" then
        ...
        return encode(v)
      end)(("guess the number : " .. _str(last_numbers[(_len(last_numbers) - 1) + 1])))) or (("guess the number : " .. _str(last_numbers[(_len(last_numbers) - 1) + 1])))))
      print((((type(("details : " ..
      (function(v)
      local function encode(x)
      if type(x) == "table" then
