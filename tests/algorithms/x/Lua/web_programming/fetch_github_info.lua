...
do
  ...
  function fetch_github_info(username)
    local url = ("https://api.github.com/users/" .. username)
    local res = _fetch(url)
    return res
  end
  function main()
    local user = fetch_github_info("octocat")
    print((((type(((user.login .. " ") .. _str(user.id))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      return encode(v)
    end)(((user.login .. " ") .. _str(user.id)))) or (((user.login .. " ") .. _str(user.id)))))
  end
  main()
