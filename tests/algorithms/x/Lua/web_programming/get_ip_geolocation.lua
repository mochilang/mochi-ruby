...
do
  ...
  function get_ip_geolocation(ip_address)
    local url = (("https://ipinfo.io/" .. ip_address) .. "/json")
    local data = _fetch(url)
    if (((data["city"] ~= nil) and (data["region"] ~= nil)) and (data["country"] ~= nil)) then
