...
do
  ...
  function random_anime_character()
    local idx = random_int(0, (function(v)
    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      if type(x) == "table" then
        ...
        return encode(v)
      end)(c.title)) or (c.title)))
      print("")
      print((((type(c.description) == "table")) and (
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        if x.__name and x.__order then
        ...
        return encode(v)
      end)(c.description)) or (c.description)))
      print("")
      print((((type(("Image saved : " .. c.image_file)) == "table")) and (
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        if x.__name and x.__order then
        ...
        return encode(v)
      end)(("Image saved : " .. c.image_file))) or (("Image saved : " .. c.image_file))))
