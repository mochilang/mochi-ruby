      ...
      elseif type(v) == 'table' and (v[1] == nil) then
        ...
        elseif type(v) == 'string' then
          ...
          elseif type(v) == 'table' then
            ...
            local j = pi[(i - 1) + 1]
            while ((j > 0) and (string.sub(s, (i + 1), (i + 1)) ~= string.sub(s, (j + 1), (j + 1)))) do
              j = pi[(j - 1) + 1]
            end
                    ...
                    elseif type(v) == 'string' then
                      ...
                      elseif type(v) == 'table' and (v[1] == nil) then
                        ...
                        function test_prefix_function()
                          local s1 = "aabcdaabc"
                          local expected1 = {0, 1, 0, 0, 0, 1, 2, 3, 4}
                          local r1 = prefix_function(s1)
                          if (not list_eq_int(r1, expected1)) then
                            _panic("prefix_function aabcdaabc failed")
                          end
                          local s2 = "asdasdad"
                          local expected2 = {0, 0, 0, 1, 2, 3, 4, 0}
                          local r2 = prefix_function(s2)
                        ...
                        function main()
                          ...
                          test_longest_prefix()
                          local r1 = prefix_function("aabcdaabc")
                          local r2 = prefix_function("asdasdad")
                          print((((type(
                          (function(v)
                          ...
                          print((((type(_str(longest_prefix("aabcdaabc"))) == "table")) and (
                          (function(v)
                          local function encode(x)
                          if type(x) == "table" then
                            if x.__name and x.__order then
                            ...
                            return encode(v)
                          end)(_str(longest_prefix("aabcdaabc")))) or (_str(longest_prefix("aabcdaabc")))))
                          print((((type(_str(longest_prefix("abcab"))) == "table")) and (
                          (function(v)
                          local function encode(x)
                          if type(x) == "table" then
                            if x.__name and x.__order then
                            ...
                            return encode(v)
                          end)(_str(longest_prefix("abcab")))) or (_str(longest_prefix("abcab")))))
                        end
                        main()
