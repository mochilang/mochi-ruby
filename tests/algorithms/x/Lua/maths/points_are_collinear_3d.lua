-- Generated by Mochi v0.10.67 on 2025-08-17 12:10 GMT+7
function input()
...
do
  ...
  function round_float(x, digits)
    ...
    local t = (function(v) if v >= 0 then return math.floor(v) else return math.ceil(v) end end)((tonumber(v) or 0))
    return (t / factor)
  end
  ...
  function are_collinear(a, b, c, accuracy)
    ...
    local cross = get_3d_vectors_cross(ab, ac)
    return is_zero_vector(cross, accuracy)
  end
  function test_are_collinear()
    local p1 = {x = 0.0, y = 0.0, z = 0.0}
    local p2 = {x = 1.0, y = 1.0, z = 1.0}
    local p3 = {x = 2.0, y = 2.0, z = 2.0}
    if (not are_collinear(p1, p2, p3, 10)) then
      _panic("collinear test failed")
    end
    local q3 = {x = 1.0, y = 2.0, z = 3.0}
  ...
  function main()
    test_are_collinear()
    local a = {x = 4.802293498137402, y = 3.536233125455244, z = 0.0}
    ...
    print((((type(_str(are_collinear(a, b, c, 10))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      elseif type(x) == "number" then
        ...
        return encode(v)
      end)(_str(are_collinear(a, b, c, 10)))) or (_str(are_collinear(a, b, c, 10)))))
      ...
      local f = {x = 1.962903518985307, y = 3.741415730125627, z = 7.0}
      print((((type(_str(are_collinear(d, e, f, 10))) == "table")) and (
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        if x.__name and x.__order then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(_str(are_collinear(d, e, f, 10)))) or (_str(are_collinear(d, e, f, 10)))))
      end
      main()
