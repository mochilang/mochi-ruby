    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' then
          ...
          print((((type(_str(find_winner(7, 3))) == "table")) and (
          (function(v)
          local function encode(x)
          if type(x) == "table" then
            if x.__name and x.__order then
            ...
            return encode(v)
          end)(_str(find_winner(7, 3)))) or (_str(find_winner(7, 3)))))
          print((((type(_str(josephus_iterative(7, 3))) == "table")) and (
          (function(v)
          local function encode(x)
          if type(x) == "table" then
            if x.__name and x.__order then
            ...
            return encode(v)
          end)(_str(josephus_iterative(7, 3)))) or (_str(josephus_iterative(7, 3)))))
