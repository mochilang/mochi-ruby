...
do
  ...
  function gamma_recursive(num)
    ...
    local int_part = (math.modf(tonumber(num) or 0))
    ...
    if (absf((num - 1.0)) < 1e-06) then
      return 1.0
    end
    return ((num - 1.0) * gamma_recursive((num - 1.0)))
  end
  function main()
    print((((type(gamma_iterative(5.0)) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      elseif type(x) == "number" then
        ...
        return encode(v)
      end)(gamma_iterative(5.0))) or (gamma_iterative(5.0))))
      print((((type(gamma_recursive(5.0)) == "table")) and (
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        if x.__name and x.__order then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(gamma_recursive(5.0))) or (gamma_recursive(5.0))))
