...
do
  ...
  local root2 = sqrt(2)
  while (idx < n) do
    local k1 = (step_size * func(xi, y[idx + 1]))
    local k2 = (step_size * func((xi + (step_size / 2)), (y[idx + 1] + (k1 / 2))))
    local k3 = (step_size * func((xi + (step_size / 2)), ((y[idx + 1] + (((-0.5) + (1 / root2)) * k1)) + ((1 - (1 / root2)) * k2))))
    local k4 = (step_size * func((xi + step_size), ((y[idx + 1] - ((1 / root2) * k2)) + ((1 + (1 / root2)) * k3))))
    y[(idx + 1) + 1] = (y[idx + 1] + ((((k1 + ((2 - root2) * k2)) + ((2 + root2) * k3)) + k4) / 6))
    xi = (xi + step_size)
    idx = (idx + 1)
  end
  return y
...
print((((type(tostring(y1[((function(v)
  ...
  elseif type(v) == 'string' then
    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      elseif type(v) == 'string' then
        ...
        end)(y1) - 1) + 1]))) or (tostring(y1[((function(v)
        if type(v) == 'table' and v.items ~= nil then
          return #v.items
        elseif type(v) == 'table' and (v[1] == nil) then
            local c = 0
