  ...
  function analyze_text(text)
    ...
    elseif type(v) == 'table' and (v[1] == nil or v[0] ~= nil) then
      ...
      function calculate_entropy(text)
        ...
        local total1 = 0
        local _k0 = {}
        for k in pairs(counts.single) do if k ~= '__name' and k ~= '__order' then table.insert(_k0, k) end end
        table.sort(_k0, function(a,b) return a<b end)
        for _, ch in ipairs(_k0) do
        ...
        elseif type(v) == 'table' and (v[1] == nil or v[0] ~= nil) then
          ...
          elseif type(v) == 'string' then
            ...
            if type(x) == "table" then
              ...
              local total2 = 0
              local _k1 = {}
              for k in pairs(counts.double) do if k ~= '__name' and k ~= '__order' then table.insert(_k1, k) end end
              table.sort(_k1, function(a,b) return a<b end)
              for _, seq in ipairs(_k1) do
