...
function lzw_compress(bits)
  local dict = {__name = "GenType1", __order = {"0", "1"}, ["0"] = 0, ["1"] = 1}
  local current = ""
  local result = ""
  local index = 2
  local i = 0
  ...
  elseif type(v) == 'table' and (v[1] == nil) then
    ...
    elseif type(v) == 'string' then
      ...
      elseif type(v) == 'table' then
        ...
        local ch = string.sub(bits, (i + 1), (i + 1))
    ...
    data = "01001100100111"
    print((((type(lzw_compress(data)) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      return encode(v)
    end)(lzw_compress(data))) or (lzw_compress(data))))
