...
do
  ...
  function main()
    local a = dual(2.0, 1.0)
    local b = dual(1.0, 0.0)
    local c = add(a, b)
    local d = mul(a, b)
    local e = div(c, d)
    print((((type(_str(e.deriv)) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      elseif type(x) == "number" then
        ...
        return encode(v)
      end)(_str(e.deriv))) or (_str(e.deriv))))
      local x = dual(2.0, 1.0)
      local y = power(x, 3)
      print((((type(_str(y.deriv)) == "table")) and (
      (function(v)
      local function encode(x)
      if type(x) == "table" then
        if x.__name and x.__order then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(_str(y.deriv))) or (_str(y.deriv))))
      end
      main()
