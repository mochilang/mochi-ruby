    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      function chr(n)
        if ((n >= 32) and (n < 127)) then
          return string.sub(ascii, ((n - 32) + 1), (n - 31))
        end
        return ""
      end
      ...
      function encrypt(content, key)
        ...
        elseif type(v) == 'table' and (v[1] == nil) then
          ...
          elseif type(v) == 'string' then
            ...
            elseif type(v) == 'table' then
              ...
              local c = ord(string.sub(content, (i + 1), (i + 1)))
              local e = xor(c, k)
        ...
        function encrypt_string(content, key)
          local chars = encrypt(content, key)
          local out = ""
        ...
        if type(x) == "table" then
          ...
          return encode(v)
        end)(encrypt(sample, 1))) == "table")) and (
        (function(v)
        local function encode(x)
        if type(x) == "table" then
          if x.__name and x.__order then
