      ...
      elseif type(v) == 'table' and (v[1] == nil) then
        ...
        elseif type(v) == 'string' then
          ...
          elseif type(v) == 'table' then
            ...
            result = (result .. string.sub(message, (pointer + 1), (pointer + 1)))
            pointer = (pointer + key)
          end
          col = (col + 1)
        end
      ...
      function decrypt_message(key, message)
        ...
        elseif type(v) == 'table' and (v[1] == nil) then
          ...
          elseif type(v) == 'string' then
            ...
            local num_cols = (msg_len // key)
            if ((msg_len % key) ~= 0) then
              num_cols = (num_cols + 1)
            end
            local num_rows = key
            local num_shaded_boxes = ((num_cols * num_rows) - msg_len)
            local plain = {}
            local i = 0
            while (i < num_cols) do
              plain = (function(lst, item)
