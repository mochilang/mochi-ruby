...
do
  ...
  if (primitive_root == (0 - 1)) then
    ...
    print((((type(("The key value generated by A is: " .. _str(a_secret))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      return encode(v)
    end)(("The key value generated by A is: " .. _str(a_secret)))) or (("The key value generated by A is: " .. _str(a_secret)))))
    print((((type(("The key value generated by B is: " .. _str(b_secret))) == "table")) and (
    (function(v)
    local function encode(x)
    if type(x) == "table" then
      if x.__name and x.__order then
      ...
      return encode(v)
    end)(("The key value generated by B is: " .. _str(b_secret)))) or (("The key value generated by B is: " .. _str(b_secret)))))
  end
