  ...
  elseif type(v) == 'table' and (v[1] == nil) then
    ...
    elseif type(v) == 'string' then
      ...
      elseif type(v) == 'table' then
        ...
        local d = math.floor(tonumber(string.sub(s, (i + 1), (i + 1))) or 0)
    ...
    function solution(max_base)
      ...
      print((((type(("solution() = " .. _str(solution(5)))) == "table")) and (
      (function(v)
      ...
      if type(x) == "table" then
        ...
        return encode(v)
      end)(("solution() = " .. _str(solution(5))))) or (("solution() = " .. _str(solution(5))))))
