...
function equal_lists(a, b)
  ...
  elseif type(v) == 'table' and (v[1] == nil) then
    ...
    function solution()
      local i = 1
      while true do
        local c = digits_count(i)
        if ((((equal_lists(c, digits_count((2 * i))) and equal_lists(c, digits_count((3 * i)))) and equal_lists(c, digits_count((4 * i)))) and equal_lists(c, digits_count((5 * i)))) and equal_lists(c, digits_count((6 * i)))) then
          return i
        end
        i = (i + 1)
      end
