        ...
        elseif type(v) == 'table' then
          ...
          elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'table' then
                ...
                elseif type(v) == 'table' and (v[1] == nil) then
                  ...
                  elseif type(v) == 'string' then
                    ...
                    end)(a[(i - 1) + 1]))) and (a[(i - 1) + 1][j + 1]) or (0))
                    local number2 = (((j > 0)) and (a[(i - 1) + 1][(j - 1) + 1]) or (0))
                    a[i + 1][j + 1] = (a[i + 1][j + 1] + (function(lst)
                    local m = nil
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              print((((type(_str(max_path(triangle))) == "table")) and (
              (function(v)
              ...
              if type(x) == "table" then
                ...
                return encode(v)
              end)(_str(max_path(triangle)))) or (_str(max_path(triangle)))))
