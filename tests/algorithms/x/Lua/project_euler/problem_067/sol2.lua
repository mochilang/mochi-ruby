...
do
  ...
  function max_path_sum(tr)
    local prev = tr[((function(v)
      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' and (v[1] == nil) then
          ...
          elseif type(v) == 'string' then
              ...
              elseif type(v) == 'table' and (v[1] == nil) then
                ...
                elseif type(v) == 'string' then
                  ...
                  elseif type(v) == 'table' then
                    ...
                    local best = max_int(prev[j + 1], prev[(j + 1) + 1])
                    new_row = (function(lst, item)
                    local res = {table.unpack(lst or {})}
                    table.insert(res, item)
                    return res
                  end)(new_row, (curr[j + 1] + best))
                  j = (j + 1)
                end
                prev = new_row
                i = (i - 1)
            ...
            print((((type(_str(max_path_sum(triangle))) == "table")) and (
            (function(v)
            ...
            if type(x) == "table" then
              ...
              return encode(v)
            end)(_str(max_path_sum(triangle)))) or (_str(max_path_sum(triangle)))))
