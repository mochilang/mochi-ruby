    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' then
          ...
          local ch = _substring(line, i, (i + 1))
          if (ch == ",") then
        ...
        elseif type(v) == 'table' and (v[1] == nil) then
          ...
          elseif type(v) == 'string' then
            ...
            elseif type(v) == 'table' then
              ...
              if (_substring(alphabet, idx, (idx + 1)) == ch) then
                return (idx + 1)
              end
              idx = (idx + 1)
            end
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'string' then
                ...
                elseif type(v) == 'table' then
                  ...
                  score = (score + letter_value(_substring(name, i, (i + 1))))
                  i = (i + 1)
                end
                return score
              end
              function main()
                local line = input()
                local names = insertion_sort(parse_names(line))
                local total = 0
                local i = 0
                while (i < (function(v)
                if type(v) == 'table' and v.items ~= nil then
                ...
                elseif type(v) == 'table' and (v[1] == nil) then
                  ...
                  elseif type(v) == 'string' then
                    ...
                    elseif type(v) == 'table' then
                      ...
                      total = (total + ((i + 1) * name_score(names[i + 1])))
                      i = (i + 1)
                    end
