...
do
  ...
  function solution()
    local targets = {1, 10, 100, 1000, 10000, 100000, 1000000}
    local idx = 0
    local product = 1
    local count = 0
    local i = 1
          ...
          elseif type(v) == 'table' and (v[1] == nil) then
            ...
            elseif type(v) == 'string' then
              ...
              elseif type(v) == 'table' then
                ...
                count = (count + 1)
                if (count == targets[idx + 1]) then
                  product = (product * math.floor(tonumber(string.sub(s, (j + 1), (j + 1))) or 0))
                  idx = (idx + 1)
                  if (idx == (function(v)
                  if type(v) == 'table' and v.items ~= nil then
                    return #v.items
