...
do
  ...
  function solution(max_base, max_power)
    ...
    while (base < max_base) do
      ...
      while (power < max_power) do
        local digits = num_digits(pow(base, power))
  ...
  print((((type(("solution(10, 22) = " .. _str(solution(10, 22)))) == "table")) and (
  (function(v)
  ...
  if type(x) == "table" then
    ...
    return encode(v)
  end)(("solution(10, 22) = " .. _str(solution(10, 22))))) or (("solution(10, 22) = " .. _str(solution(10, 22))))))
