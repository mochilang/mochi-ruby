    ...
    elseif type(v) == 'table' and (v[1] == nil) then
      ...
      elseif type(v) == 'string' then
        ...
        elseif type(v) == 'table' then
          ...
          sum = (sum + math.floor(tonumber(string.sub(s, (i + 1), (i + 1))) or 0))
          i = (i + 1)
        end
        return sum
      end
      function solution(a, b)
        ...
        while (base < a) do
          local power = 0
          while (power < b) do
            local value = pow_int(base, power)
            local ds = digital_sum(value)
            if (ds > max_sum) then
              max_sum = ds
            end
            power = (power + 1)
      ...
      function main()
        test_solution()
        print((((type(_str(solution(100, 100))) == "table")) and (
        (function(v)
        ...
        if type(x) == "table" then
          ...
          return encode(v)
        end)(_str(solution(100, 100)))) or (_str(solution(100, 100)))))
      end
      main()
