...
elseif type(v) == 'table' and (v[1] == nil or v[0] ~= nil) then
  ...
  do
    ...
    function cramers_rule_2x2(eq1, eq2)
      if ((_len(eq1) ~= 3) or (_len(eq2) ~= 3)) then
        _panic("Please enter a valid equation.")
      end
      if ((((eq1[0 + 1] == 0.0) and (eq1[1 + 1] == 0.0)) and (eq2[0 + 1] == 0.0)) and (eq2[1 + 1] == 0.0)) then
      ...
      if (determinant == 0.0) then
        if ((determinant_x == 0.0) and (determinant_y == 0.0)) then
    ...
    function test_cramers_rule_2x2()
      local r1 = cramers_rule_2x2({2.0, 3.0, 0.0}, {5.0, 1.0, 0.0})
      if ((r1[0 + 1] ~= 0.0) or (r1[1 + 1] ~= 0.0)) then
        _panic("Test1 failed")
      end
      local r2 = cramers_rule_2x2({0.0, 4.0, 50.0}, {2.0, 0.0, 26.0})
      if ((r2[0 + 1] ~= 13.0) or (r2[1 + 1] ~= 12.5)) then
        _panic("Test2 failed")
      end
    end
    function main()
      ...
      if type(x) == "table" then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(cramers_rule_2x2({11.0, 2.0, 30.0}, {1.0, 0.0, 4.0})))
      end
      main()
