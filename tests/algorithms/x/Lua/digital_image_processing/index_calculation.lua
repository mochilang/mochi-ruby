...
do
  ...
  function main()
    ...
    local redEdge = 40
    local nir = 100
    print((((type(("NDVI=" .. _str(ndvi(red, nir)))) == "table")) and (
    (function(v)
    ...
    if type(x) == "table" then
      ...
      return encode(v)
    end)(("NDVI=" .. _str(ndvi(red, nir))))) or (("NDVI=" .. _str(ndvi(red, nir))))))
    print((((type(("CCCI=" .. _str(ccci(red, redEdge, nir)))) == "table")) and (
    (function(v)
    local function encode(x)
    if type(x) == "table" then
      if x.__name and x.__order then
      ...
      return encode(v)
    end)(("CCCI=" .. _str(ccci(red, redEdge, nir))))) or (("CCCI=" .. _str(ccci(red, redEdge, nir))))))
    print((((type(("CVI=" .. _str(cvi(red, green, nir)))) == "table")) and (
    (function(v)
    local function encode(x)
    if type(x) == "table" then
      if x.__name and x.__order then
      ...
      return encode(v)
    end)(("CVI=" .. _str(cvi(red, green, nir))))) or (("CVI=" .. _str(cvi(red, green, nir))))))
  end
  main()
