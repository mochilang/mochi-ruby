...
elseif type(v) == 'table' and (v[1] == nil or v[0] ~= nil) then
  ...
  elseif type(v) == 'string' then
    ...
    function main()
      ...
      print((((type(("No. of Operation required: " .. _str(m[1 + 1][(n - 1) + 1]))) == "table")) and (
      (function(v)
      ...
      if type(x) == "table" then
        ...
        elseif type(x) == "number" then
          ...
          return encode(v)
        end)(("No. of Operation required: " .. _str(m[1 + 1][(n - 1) + 1])))) or (("No. of Operation required: " .. _str(m[1 + 1][(n - 1) + 1])))))
