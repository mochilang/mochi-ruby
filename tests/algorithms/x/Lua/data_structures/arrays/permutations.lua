            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'string' then
                ...
                elseif type(v) == 'table' then
                  ...
                  local n = current[0 + 1]
                  local rest = tail(current)
                  local perms = permute_recursive(rest)
                  local j = 0
                  while (j < (function(v)
                  if type(v) == 'table' and v.items ~= nil then
                    return #v.items
              ...
              elseif type(v) == 'table' and (v[1] == nil) then
                ...
                elseif type(v) == 'table' and (v[1] == nil) then
                  ...
                  if type(x) == "table" then
                    ...
                    return encode(v)
                  end)(permute_recursive({1, 2, 3}))) == "table")) and (
                  (function(v)
                  local function encode(x)
                  if type(x) == "table" then
                    if x.__name and x.__order then
                  ...
                  if type(x) == "table" then
                    ...
                    return encode(v)
                  end)(permute_recursive({1, 2, 3})))) or (
                  (function(v)
                  local function encode(x)
                  if type(x) == "table" then
                    if x.__name and x.__order then
                  ...
                  if type(x) == "table" then
                    ...
                    return encode(v)
                  end)(permute_backtrack({1, 2, 3}))) == "table")) and (
                  (function(v)
                  local function encode(x)
                  if type(x) == "table" then
                    if x.__name and x.__order then
                  ...
                  if type(x) == "table" then
                    ...
                    return encode(v)
                  end)(permute_backtrack({1, 2, 3})))) or (
                  (function(v)
                  local function encode(x)
                  if type(x) == "table" then
                    if x.__name and x.__order then
