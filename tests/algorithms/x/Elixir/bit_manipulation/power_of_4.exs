...
defmodule Main do
  ...
  def main() do
    IO.puts(Kernel.inspect(power_of_4(1)))
    IO.puts(Kernel.inspect(power_of_4(2)))
    IO.puts(Kernel.inspect(power_of_4(4)))
    IO.puts(Kernel.inspect(power_of_4(6)))
    IO.puts(Kernel.inspect(power_of_4(64)))
  end
end
Main.main()
