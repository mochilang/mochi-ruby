# Generated by Mochi compiler v0.10.26 on 2025-07-16T12:46:36Z
defmodule Pixel do
...
defmodule Main do
  ...
  def bezier3(b, x1, y1, x2, y2, x3, y3, x4, y4, p) do
    try do
      px = []
      _ = px
      py = []
      ...
      fx4 = String.to_float(x4)
      fy4 = String.to_float(y4)
      i = 0

      t7 = fn t7, i, px, py ->
        try do
          if i <= @b3Seg do
            d = String.to_float(i) / String.to_float(@b3Seg)
            a = 1 - d
            _ = a
            bcoef = a * a
            _ = bcoef
            ...
            d2 = ccoef * d
            _ = d2
            px = Map.put(px, i, String.to_integer(a2 * fx1 + b2 * fx2 + c2 * fx3 + d2 * fx4))
            py = Map.put(py, i, String.to_integer(a2 * fy1 + b2 * fy2 + c2 * fy3 + d2 * fy4))
            i = i + 1
            t7.(t7, i, px, py)
          else
            {:ok, i, px, py}
  ...
  def main do
    ...
    b = newBitmap(400, 300)
    _ = b
    fillRgb(b, 16_773_055)
    bezier3(b, 20, 200, 700, 50, -300, 50, 380, 150, pixelFromRgb(4_165_615))
  end
end
