// Generated by Mochi compiler v0.10.30 on 2025-07-18T16:00:16Z
using System;
...
class Program
{
    ...
    static string takeRunes(string s, int n)
    {
        ...
        while (idx < s.Length)
        {
            if (count == n)
            {
                return s.Substring((int)0, ((int)(idx) - (int)(0)));
            }
            idx = (idx + 1);
            count = (count + 1);
        }
    ...
    static int abbrevLen(List<string> words)
    {
        ...
        while (true)
        {
            ...
            while (i < size)
            {
                abbrs = new List<string>(abbrs) { takeRunes(words[(int)i], l) };
                i = (i + 1);
            }
    ...
    static void main()
    {
        ...
        while (i < lines.Count)
        {
            List<string> words = fields(lines[(int)i]);
            int l = abbrevLen(words);
            Console.WriteLine(((pad2(l) + "  ") + lines[(int)i]));
            i = (i + 1);
        }
    }
