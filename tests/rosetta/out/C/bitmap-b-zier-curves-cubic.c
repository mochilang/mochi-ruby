...
int bezier3(map_string_int b, int x1, int y1, int x2, int y2, int x3, int y3,
  ...
  __auto_type fx4 = (double)(x4);
  __auto_type fy4 = (double)(y4);
  i = 0;
  while (i <= b3Seg) {
    __auto_type d = ((double)(i)) / ((double)(b3Seg));
    __auto_type a = 1.0 - d;
    __auto_type bcoef = a * a;
    __auto_type ccoef = d * d;
    __auto_type a2 = a * bcoef;
    __auto_type b2 = 3.0 * bcoef * d;
    __auto_type c2 = 3.0 * a * ccoef;
    __auto_type d2 = ccoef * d;
