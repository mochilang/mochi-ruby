// Generated by Mochi transpiler v0.10.57 on 2025-08-04 22:42:53 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <vector>
...
int main() {
    {
        ...
        while ((n < limit)) {
            if (isPrime(i)) {
                n = (n + int64_t(1));
                std::string nStr = padRight(([&]{ std::ostringstream ss; ss << std::boolalpha << n; return ss.str(); }()), int64_t(2));
                std::string pStr = padLeft(commatize(i), int64_t(19));
                std::cout << (((std::string("n = ") + nStr) + std::string("  ")) + pStr);
                std::cout << std::endl;
                i = ((i + i) - int64_t(1));
            }
            i = (i + int64_t(1));
