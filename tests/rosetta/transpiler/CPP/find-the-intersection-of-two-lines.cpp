// Generated by Mochi transpiler v0.10.57 on 2025-08-04 21:23:42 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
std::ostream& operator<<(std::ostream& os, const Line& v) {
    os << '{' << "'slope': "<< std::fixed << std::setprecision(1) << v.slope
 << ", " << "'yint': "<< std::fixed << std::setprecision(1) << v.yint
 << '}';
    return os;
}

Line createLine(const Point& a, const Point& b);
double evalX(const Line& l, double x);
...
Point intersection(const Line& l1, const Line& l2) {
    ...
    double x = ((double)((l2.yint - l1.yint)) / ((l1.slope - l2.slope)));
    double y = evalX(l1, x);
