// Generated by Mochi transpiler v0.10.57 on 2025-08-04 21:34:04 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <type_traits>
...
std::vector<std::string> records = std::vector<std::string>{_repeat(std::string("abcdefgh"), int64_t(10)), _repeat(std::string("ijklmnop"), int64_t(10)), _repeat(std::string("qrstuvwx"), int64_t(10))};
