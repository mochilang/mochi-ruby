// Generated by Mochi transpiler v0.10.57 on 2025-08-05 01:46:46 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
Complex neg(const Complex& a);
Complex inv(const Complex& a);
Complex conj(const Complex& a);
std::string cstr(const Complex& a);
int main();

Complex a = Complex{.re = 1.0, .im = 1.0};
...
Complex inv(const Complex& a) {
    ...
    return Complex{.re = ((double)(a.re) / (denom)), .im = ((double)(-a.im) / (denom))};
}
...
std::string cstr(const Complex& a) {
    std::string s = (std::string("(") + ([&]{ std::ostringstream ss; ss << std::boolalpha << a.re; return ss.str(); }()));
    if ((a.im >= int64_t(0))) {
        s = (((s + std::string("+")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << a.im; return ss.str(); }())) + std::string("i)"));
    } else {
        s = ((s + ([&]{ std::ostringstream ss; ss << std::boolalpha << a.im; return ss.str(); }())) + std::string("i)"));
    }
    return s;
}
