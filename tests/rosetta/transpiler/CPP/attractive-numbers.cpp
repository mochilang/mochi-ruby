// Generated by Mochi transpiler v0.10.57 on 2025-08-05 01:51:34 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int main() {
    {
        ...
        int64_t lineCount = int64_t(0);
        int64_t i = int64_t(1);
        while ((i <= max)) {
            int64_t c = countPrimeFactors(i);
            if (isPrime(c)) {
                line = (line + pad4(i));
                count = (count + int64_t(1));
                lineCount = (lineCount + int64_t(1));
                if ((lineCount == int64_t(20))) {
                    std::cout << line;
                    std::cout << std::endl;
                    line = std::string("");
                    lineCount = int64_t(0);
