// Generated by Mochi transpiler v0.10.57 on 2025-08-05 01:51:51 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
double sel(std::vector<double> list, int64_t k);
...
double median(const std::vector<double>& a) {
    ...
    if (((arr.size() % int64_t(2)) == int64_t(0))) {
        return ((double)((med + arr[(half - int64_t(1))])) / (2.0));
    }
    return med;
}
