// Generated by Mochi transpiler v0.10.57 on 2025-08-05 01:46:39 GMT+7
#include <iostream>
#include <string>
#include <sstream>
#include <iomanip>
...
int main() {
    {
        ...
        while ((theta < stop)) {
            ...
            if (((count % int64_t(100)) == int64_t(0))) {
                std::cout << ((([&]{ std::ostringstream ss; ss << std::boolalpha << (centre + x); return ss.str(); }()) + std::string(",")) + ([&]{ std::ostringstream ss; ss << std::boolalpha << (centre - y); return ss.str(); }()));
                std::cout << std::endl;
            }
