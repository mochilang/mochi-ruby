// Generated by Mochi transpiler v0.10.57 on 2025-08-05 01:46:11 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
int main() {
    {
        ...
        for (int64_t n : std::vector<int64_t>{int64_t(0), int64_t(1), int64_t(2), int64_t(3), int64_t(4), int64_t(5), int64_t(10), int64_t(40), -int64_t(1)}) {
            if ((n < int64_t(0))) {
