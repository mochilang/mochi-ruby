// Generated by Mochi transpiler v0.10.56 on 2025-08-03 21:42:53 GMT+7
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
std::vector<int64_t> gen(int64_t idx, int64_t cur, bool used) {
    ...
    return ([&]{ auto __lhs = with; auto __rhs = without; __lhs.insert(__lhs.end(), __rhs.begin(), __rhs.end()); return __lhs; }());
}
