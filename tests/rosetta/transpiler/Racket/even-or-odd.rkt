...
(define (showInt n)
  (let/ec _return (begin
(define line (string-append (string-append "Testing integer " (pad n 3)) ":  "))
(if (equal? (modulo n 2) 0) (let ()
(set! line (string-append line "even "))
) (let ()
(set! line (string-append line " odd "))
))
(if (equal? (modulo n 2) 0) (let ()
(set! line (string-append line "even"))
) (let ()
...
(define (showBig s)
  (let/ec _return (begin
(define b (parseBigInt s))
(define line (string-append (string-append "Testing big integer " (format "~a" b)) ":  "))
