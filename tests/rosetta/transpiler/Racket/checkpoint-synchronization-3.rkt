...
(let/ec _break (let loop ()
  (if (< i (cond [(string? up) (string-length up)] [(hash? up) (hash-count up)] [else (length up)])) (let ()
    (if (string=? ch (slice up i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))) (let ()
(_return (slice low i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
) (void))
...
(let/ec _break (for ([p partList])
  (let/ec _cont
(displayln (string-append p " worker running"))
  )))
...
(let/ec _break (for ([p partList])
  (let/ec _cont
(displayln (string-append p " worker stopped"))
  )))
  ))
