...
(let/ec _break (let loop ()
  (if (<= i (- (cond [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)]) n)) (let ()
    (if (string=? (slice s i (let ([__l i] [__r n]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))) sep) (let ()
(set! out (append out (list (slice s start i))))
...
(set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    ...
    (loop)) (void))))
(set! out (append out (list (slice s start (cond [(string? s) (string-length s)] [(hash? s) (hash-count s)] [else (length s)])))))
(_return out)
))
)
(define (htmlEscape s)
