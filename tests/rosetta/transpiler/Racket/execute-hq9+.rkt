...
(define i 0)
(let/ec _break (let loop ()
  (if (< i (cond [(string? code) (string-length code)] [(hash? code) (hash-count code)] [else (length code)])) (let ()
    (define ch (slice code i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r)))))
    (if (string=? ch "H") (let ()
...
(if (string=? ch "+") (let ()
(set! acc (let ([__l acc] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
) (void))
))
))
))
