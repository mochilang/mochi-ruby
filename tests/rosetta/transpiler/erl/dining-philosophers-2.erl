...
{Hunger, Philosophers} = Fun(Philosophers, Hunger, Philosophers),
        I = 0,
        Fun_3 = fun Fun_3_loop(Hunger, I, Philosophers) ->
    case (I < length(Philosophers)) of
        true ->
            Name = lists:nth(I + 1, Philosophers),
            H = 0,
            Fun_2 = fun Fun_2_loop(H, Hunger, I, Name, Philosophers) ->
    case (H < Hunger) of
        true ->
            ...
            H_2 = (H + 1),
            Fun_2_loop(H_2, Hunger, I, Name, Philosophers);
        _ -> {H, Hunger, I, Name, Philosophers}
    end
end,
{H_2, Hunger, I, Name, Philosophers} = Fun_2(H, Hunger, I, Name, Philosophers),
            io:format("~ts~n", [(Name ++ " satisfied")]),
            io:format("~ts~n", [(Name ++ " left the table")]),
            I_2 = (I + 1),
            Fun_3_loop(Hunger, I_2, Philosophers);
        _ -> {Hunger, I, Philosophers}
    end
end,
{Hunger, I_2, Philosophers} = Fun_3(Hunger, I, Philosophers),
        io:format("~ts~n", ["table empty"]),
        nil
