      ...
      elseif type(v) == 'table' and (v[1] == nil) then
        ...
        elseif type(v) == 'string' then
          ...
          elseif type(v) == 'table' then
            ...
            local extra = {[6] = {274177, 67280421310721}, [7] = {parseBigInt("59649589127497217"), parseBigInt("5704689200685129054721")}}
            print("\nFactors:")
            local i = 0
            while (i < (function(v)
            if type(v) == 'table' and v.items ~= nil then
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'string' then
                ...
                elseif type(v) == 'table' then
                  ...
                  local facs = {}
                  if (i <= 5) then
                    facs = primeFactorsBig(nums[i + 1])
                  else
                    facs = extra[i]
                  end
                  print(((("F" .. tostring(i)) .. " = ") .. show_list(facs)))
                  i = (i + 1)
                end
              end
              main()
