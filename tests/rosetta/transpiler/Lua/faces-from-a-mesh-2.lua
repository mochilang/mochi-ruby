      ...
      function listStr(xs)
        ...
        elseif type(v) == 'table' and (v[1] == nil) then
          ...
          function main()
            ...
            local e = {{a = 7, b = 11}, {a = 1, b = 11}, {a = 1, b = 7}}
            local f = {{a = 11, b = 23}, {a = 1, b = 17}, {a = 17, b = 23}, {a = 1, b = 11}}
            local g = {{a = 8, b = 14}, {a = 17, b = 19}, {a = 10, b = 12}, {a = 10, b = 14}, {a = 12, b = 17}, {a = 8, b = 18}, {a = 18, b = 19}}
            local h = {{a = 1, b = 3}, {a = 9, b = 11}, {a = 3, b = 11}, {a = 1, b = 11}}
            ...
            elseif type(v) == 'table' and (v[1] == nil) then
              ...
              elseif type(v) == 'string' or type(v) == 'table' then
                ...
                local per = faceToPerim(faces[idx + 1])
                if (per == _nil) then
                  print((("  " .. names[idx + 1]) .. " => Invalid edge format"))
                else
                  print(((("  " .. names[idx + 1]) .. " => ") .. listStr(per)))
                end
                idx = (idx + 1)
              end
            end;
