...
function lower(ch)
  ...
  elseif type(v) == 'table' and (v[1] == nil) then
    ...
    elseif type(v) == 'string' or type(v) == 'table' then
      ...
      if (ch == string.sub(up, i + 1, (i + 1))) then
        return string.sub(low, i + 1, (i + 1))
      end
      i = (i + 1)
    end
    return ch
  ...
  for _, p in ipairs(partList) do
    print((tostring(p) .. " worker running"))
  end;
  ...
  for cycle = 1, (nAssemblies + 1) - 1 do
    ...
    for _, p in ipairs(partList) do
      ...
      print(((tostring(p) .. " worker completed ") .. string.lower(p)))
      a = (a .. string.lower(p))
    end
    print((((a .. " assembled.  cycle ") .. tostring(cycle)) .. " complete"))
  end;
  
  for _, p in ipairs(partList) do
    print((tostring(p) .. " worker stopped"))
  end;
