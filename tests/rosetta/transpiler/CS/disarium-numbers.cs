...
class Program {
    ...
    public static long pow(long base_0, long exp_1) {
        long result_2 = 1;
        long i_3 = 0;
        while ((i_3 < exp_1)) {
    ...
    public static bool isDisarium(long n_4) {
        ...
        while ((i_9 >= 0)) {
            sum_7 = (sum_7 + Program.pow(digits_5[(int)(i_9)], pos_8));
            pos_8 = (pos_8 + 1);
            i_9 = (i_9 - 1);
        };
        return (sum_7 == n_4);
    ...
    public static void main() {
        ...
        while (((count_10 < 19) && (n_11 < 3000000))) {
            if (Program.isDisarium(n_11)) {
                Console.WriteLine(Program._fmtTop(_fmt(n_11)));
                count_10 = (count_10 + 1);
            }
            n_11 = (n_11 + 1);
        };
        Console.WriteLine(Program._fmtTop((("\nFound the first " + _fmt(count_10)) + " Disarium numbers.")));
    }
