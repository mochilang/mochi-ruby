...
class Program {
    ...
    static dynamic res_0 = testpkg.ECDSAExample();
    static void Main() {
        {
            var __memStart = _mem();
            var __start = _now();
            Console.WriteLine(_fmtTop((((dynamic)"Private key:\nD: ") + ((dynamic)res_0.D))));
            Console.WriteLine(_fmtTop("\nPublic key:"));
            Console.WriteLine(_fmtTop((((dynamic)"X: ") + ((dynamic)res_0.X))));
            Console.WriteLine(_fmtTop((((dynamic)"Y: ") + ((dynamic)res_0.Y))));
            Console.WriteLine(_fmtTop("\nMessage: Rosetta Code"));
            Console.WriteLine(_fmtTop((((dynamic)"Hash   : ") + ((dynamic)res_0.Hash))));
            Console.WriteLine(_fmtTop("\nSignature:"));
            Console.WriteLine(_fmtTop((((dynamic)"R: ") + ((dynamic)res_0.R))));
            Console.WriteLine(_fmtTop((((dynamic)"S: ") + ((dynamic)res_0.S))));
            Console.WriteLine(_fmtTop(("\nSignature verified: " + (res_0.Valid).ToString())));
            var __end = _now();
            var __memEnd = _mem();
