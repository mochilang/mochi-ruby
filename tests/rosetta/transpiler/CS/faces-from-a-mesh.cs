...
class Program {
    ...
    static bool sliceEqual(long[] a_3, long[] b_4) {
        long i_5 = 0;
        while ((i_5 < a_3.Length)) {
            if ((a_3[(int)(i_5)] != b_4[(int)(i_5)])) {
                return false;
            }
            i_5 = (i_5 + 1);
        };
    ...
    static void reverse(long[] xs_6) {
        long i_7 = 0;
        long j_8 = (((dynamic)(xs_6.Length)) - ((dynamic)(1)));
        while ((i_7 < j_8)) {
            long t_9 = xs_6[(int)(i_7)];
            xs_6[i_7] = xs_6[(int)(j_8)];
            xs_6[j_8] = t_9;
            i_7 = (i_7 + 1);
            j_8 = (j_8 - 1);
        };
    ...
    static long[] copyInts(long[] xs_10) {
        long[] out_11 = new long[]{};
        foreach (var v_12 in xs_10) {
            out_11 = (Enumerable.ToArray(Enumerable.Append(out_11, v_12)));
        };
        return out_11;
    }
    ...
    static void Main() {
        {
            ...
            long idx2_55 = 0;
            while ((idx2_55 < faces_53.Length)) {
                var per_56 = faceToPerim(faces_53[(int)(idx2_55)]);
                if ((per_56 == null)) {
                    Console.WriteLine(_fmtTop((("  " + names_54[(int)(idx2_55)]) + " => Invalid edge format")));
                } else {
                    Console.WriteLine(_fmtTop(((("  " + names_54[(int)(idx2_55)]) + " => ") + listStr((per_56 as long[]) ?? new long[]{}))));
                }
                idx2_55 = (idx2_55 + 1);
            }
            var __end = _now();
