...
class Program {
    ...
    public static string operation(Delegator d_0) {
    ...
    public static Dictionary<string, Func<string>> newDelegate() {
    ...
    static void Main() {
        {
            var __memStart = _mem();
            var __start = _now();
            Console.WriteLine(Program._fmtTop(Program.operation(a_2)));
            a_2._delegate = new Dictionary<string, Func<string>>{};
            Console.WriteLine(Program._fmtTop(Program.operation(a_2)));
            a_2._delegate = Program.newDelegate();
            Console.WriteLine(Program._fmtTop(Program.operation(a_2)));
            var __end = _now();
            var __memEnd = _mem();
