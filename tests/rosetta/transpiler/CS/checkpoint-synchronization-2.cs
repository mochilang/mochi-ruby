    ...
    static void Main() {
        {
            ...
            for (var cycle_6 = 1; cycle_6 < (nAssemblies_5 + 1); cycle_6++) {
                Console.WriteLine(Program._fmtTop(("begin assembly cycle " + _fmt(cycle_6))));
                string a_7 = "";
                foreach (string p_8 in partList_4) {
                    Console.WriteLine(Program._fmtTop((p_8 + " worker begins part")));
                    Console.WriteLine(Program._fmtTop(((p_8 + " worker completed ") + Program.lower(p_8))));
                    a_7 = (a_7 + Program.lower(p_8));
                }
                Console.WriteLine(Program._fmtTop((((a_7 + " assembled.  cycle ") + _fmt(cycle_6)) + " complete")));
            }
            var __end = _now();
            var __memEnd = _mem();
