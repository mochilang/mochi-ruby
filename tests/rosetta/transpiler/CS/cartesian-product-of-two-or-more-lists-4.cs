...
class Program {
    ...
    public static long[] copy(long[] xs_6) {
        long[] out_7 = new long[]{};
        foreach (long v_8 in xs_6) {
            out_7 = (Enumerable.ToArray(Enumerable.Append(out_7, v_8)));
        };
        return out_7;
    }

    public static long[][] cartN(object lists_9) {
        if ((lists_9 == null)) {
            return new long[][]{};
        };
        ...
        long last_12 = (a_10.Length - 1);
        long[][] left_13 = Program.cartN(a_10.Skip((int)(0)).Take((int)((last_12 - 0))).ToArray());
        foreach (long[] p_14 in left_13) {
            foreach (long x_15 in a_10[(int)(last_12)]) {
                long[] row_16 = Program.copy(p_14);
