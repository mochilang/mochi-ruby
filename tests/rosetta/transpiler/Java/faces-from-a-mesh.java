...
arr[j_2 + 1] = a;
    ...
    public static void main(String[] args) {
        ...
        e_2 = new Edge[]{new Edge(7, 11), new Edge(1, 11), new Edge(1, 7)};
        f = new Edge[]{new Edge(11, 23), new Edge(1, 17), new Edge(17, 23), new Edge(1, 11)};
        g = new Edge[]{new Edge(8, 14), new Edge(17, 19), new Edge(10, 12), new Edge(10, 14), new Edge(12, 17), new Edge(8, 18), new Edge(18, 19)};
        h = new Edge[]{new Edge(1, 3), new Edge(9, 11), new Edge(3, 11), new Edge(1, 11)};
        System.out.println("\nEdge to perimeter format translations:");
        faces = new Edge[][]{e_2, f, g, h};
        names = new String[]{"E", "F", "G", "H"};
        idx2 = 0;
        while (idx2 < faces.length) {
            Object per = faceToPerim(faces[idx2]);
            if ((per == null)) {
                System.out.println("  " + names[idx2] + " => Invalid edge format");
            } else {
                System.out.println("  " + names[idx2] + " => " + String.valueOf(listStr(((int[])(per)))));
            }
            idx2 = idx2 + 1;
        }
    }
