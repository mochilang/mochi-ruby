public class Main {
    static class Todo {
        ...
        @Override public String toString() {
            return String.format("{'userId': %s, 'id': %s, 'title': '%s', 'completed': %s}", String.valueOf(userId), String.valueOf(id), String.valueOf(title), String.valueOf(completed));
        }
    }
    ...
    static Todo _fetch_Todo(String url) {
        return _cast(Todo.class, _fetch(url));
    }
