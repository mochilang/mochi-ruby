public class Main {
    ...
    static String removeChar(String s, String ch) {
        String res = "";
        int i_1 = 0;
        while (i_1 < _runeLen(s)) {
            String c = _substr(s, i_1, i_1 + 1);
            if (!(c.equals(ch))) {
                res = res + c;
            }
            i_1 = i_1 + 1;
    ...
    static String g2l(String pieces) {
        ...
        while (i_2 < _runeLen(pieces)) {
            ...
            res_1 = res_1 + ((String)(g2lMap).get(ch));
            i_2 = i_2 + 1;
        }
        return res_1;
    }
    ...
    static int spid(String pieces) {
        ...
        String piecesN = String.valueOf(removeChar(String.valueOf(removeChar(pieces, "Q")), "B"));
        int n1 = ((Number)(piecesN.indexOf("N"))).intValue();
        int n2 = ((Number)(_substr(piecesN, n1 + 1, _runeLen(piecesN)).indexOf("N"))).intValue() + n1 + 1;
        int N = (int)(((int)(ntable).get(String.valueOf(n1) + String.valueOf(n2))));
        String piecesQ = String.valueOf(removeChar(pieces, "B"));
