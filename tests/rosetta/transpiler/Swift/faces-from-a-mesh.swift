// Generated by Mochi transpiler v0.10.54 on 2025-08-02 12:23:35 GMT+7
import Foundation
...
do {
    ...
    while (idx2 < Int(((faces).count))) {
        ...
        == String(describing: nil as Any?)
            ...
            print(_p((("  " + (names[idx2] as! String)) + " => Invalid edge format")))
        } else {
            print(_p(((("  " + (names[idx2] as! String)) + " => ") + String(describing: listStr((per as! [Int]))))))
        }
        idx2 = Int((idx2 &+ 1))
    }
    let _benchEnd = _now()
