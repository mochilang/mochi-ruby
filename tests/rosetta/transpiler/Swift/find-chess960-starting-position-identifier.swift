// Generated by Mochi transpiler v0.10.50 on 2025-07-31 00:24:16 GMT+7
import Foundation
...
do {
    ...
    func strReplace(_ s: String, _ old: String, _ new: String) -> String {
        var res: String = ""
        var i: Int = 0
        while (i < Int(((s).count))) {
            if (((Int(((old).count)) > 0) && ((i + Int(((old).count))) <= Int(((s).count)))) && (String(describing: String(Array(String(describing: (s as! String)))[(i as! Int)..<((i + Int(((old).count))) as! Int)])) == old)) {
                res = ((res + new) as! String)
                i = ((i + Int(((old).count))) as! Int)
            } else {
    ...
    func g2l(_ pieces: String) -> String {
        ...
        while (i < Int(((pieces).count))) {
            ...
            lets = ((lets + g2lMap[ch]!) as! String)
            i = ((i + 1) as! Int)
        }
        return (lets as! String)
    }
    func spid(_ pieces: String) -> Int {
        ...
        for one in (["K", "Q"] as! [String]) {
            ...
            var i: Int = 0
            while (i < Int(((pieces).count))) {
                if (String(describing: String(Array(String(describing: (pieces as! String)))[(i as! Int)..<((i + 1) as! Int)])) == one) {
        ...
        for two in (["R", "N", "B"] as! [String]) {
            ...
            var i: Int = 0
            while (i < Int(((pieces).count))) {
                if (String(describing: String(Array(String(describing: (pieces as! String)))[(i as! Int)..<((i + 1) as! Int)])) == two) {
                    count = ((count + 1) as! Int)
                }
                i = ((i + 1) as! Int)
            }
        ...
        var piecesN: String = String(describing: strReplace((pieces as! String), "Q", ""))
        piecesN = String(describing: strReplace((piecesN as! String), "B", ""))
        ...
        let np = (_p(n1) + _p(n2))
        let N = ntable[np]!
        var piecesQ: String = String(describing: strReplace((pieces as! String), "B", ""))
