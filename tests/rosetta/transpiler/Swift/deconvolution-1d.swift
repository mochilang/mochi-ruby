// Generated by Mochi transpiler v0.10.54 on 2025-08-02 11:49:57 GMT+7
import Foundation
...
func listToStringInts(_ xs: [Double]) -> String {
    var s: String = "["
    var i: Int = 0
    while (i < Int(((xs).count))) {
        s = ((s + _p(Int(xs[i]))) as! String)
        if (i < (Int(((xs).count)) &- 1)) {
            s = ((s + " ") as! String)
        }
        i = Int((i &+ 1))
...
func main() {
    ...
    print(_p(String(describing: listToStringInts((h as! [Double])))))
    print(_p(String(describing: listToStringInts((deconv((g as! [Double]), (f as! [Double])) as! [Double])))))
    print(_p(String(describing: listToStringInts((f as! [Double])))))
    print(_p(String(describing: listToStringInts((deconv((g as! [Double]), (h as! [Double])) as! [Double])))))
}
_ = main()
