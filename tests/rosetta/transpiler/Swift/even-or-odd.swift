// Generated by Mochi transpiler v0.10.42 on 2025-07-28 10:42:34 GMT+7
import Foundation
...
do {
    ...
    func parseBigInt(_ str: String) -> BigInt {
        var i: Int = 0
        var neg: Bool = false
        if ((Int(((str).count)) > 0) && (String(describing: String(Array(String(describing: String(describing: str)))[0..<1])) == "-")) {
            neg = true
            i = 1
        }
        var n: BigInt = BigInt(BigInt(0))
        while (i < Int(((str).count))) {
            let ch = String(describing: String(Array(String(describing: String(describing: str)))[Int(i)..<Int((i + 1))]))
            let d = Int(ch)
            n = BigInt(((n * BigInt(10)) + BigInt(d)))
            i = Int((i + 1))
        }
        if neg {
            n = BigInt(-n)
    ...
    func showInt(_ n: Int) {
        var line: String = (("Testing integer " + String(describing: pad(Int(n), 3))) + ":  ")
        if ((n % 2) == 0) {
            line = String(describing: (line + "even "))
        } else {
            line = String(describing: (line + " odd "))
        }
        if ((n % 2) == 0) {
            line = String(describing: (line + "even"))
        } else {
    ...
    func showBig(_ s: String) {
        let b = parseBigInt(String(describing: s))
        var line: String = (("Testing big integer " + _p(b)) + ":  ")
    ...
    func main() {
        ...
        _ = showInt(1)
        _ = showInt(2)
        _ = showBig("-222222222222222222222222222222222222")
        _ = showBig("-1")
        _ = showBig("0")
        _ = showBig("1")
        _ = showBig("222222222222222222222222222222222222")
