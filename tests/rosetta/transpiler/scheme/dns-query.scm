        ...
        (let loop ((r str) (acc '()))
          (let ((cur (string-contains r del)))
            (if cur
                ...
                (reverse (cons r acc)))))))))
(let ((start1 (now))) (begin (define res (_lookup_host "www.kame.net")) (define addrs (list-ref res 0)) (define err (list-ref res 1)) (if (equal? err (quote ())) (begin (_display (to-str (to-str addrs))) (newline)) (begin (_display (to-str err)) (newline))) (let ((end2 (now))) (let ((dur3 (quotient (- end2 start1) 1000))) (begin (_display (string-append "{\n  \"duration_us\": " (number->string dur3) ",\n  \"memory_bytes\": " (number->string (_mem)) ",\n  \"name\": \"main\"\n}")) (newline))))))
