...
(let ((start7 (now)
 ...
 (begin (let ((zi (/ 1.0 (+ x y)
)
)
)
 (begin (let ((numbers (_list x y z)
)
)
 (begin (let ((inverses (_list xi yi zi)
)
)
 (begin (let ((mfs (_list)
)
 ...
 (begin (set! mfs (append mfs (_list (multiplier (list-ref numbers i)
 (list-ref inverses i)
)
)
)
 ...
 (begin (_display (to-str (to-str (mf 1.0)
)
)
)
 (newline)
