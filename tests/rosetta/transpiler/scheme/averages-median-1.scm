;; Generated on 2025-07-25 20:48 +0700
...
(let ((start8 (now)
 ...
 (begin (let ((m (cond ((string? arr)
 (substring arr half (+ half 1)
)
)
 ((hash-table? arr)
 (hash-table-ref arr half)
)
 (else (list-ref arr half)
)
)
)
)
 ...
 2)
 0)
 (begin (set! m (/ (+ m (cond ((string? arr)
 (substring arr (- half 1)
 (+ (- half 1)
 1)
)
)
 ((hash-table? arr)
 (hash-table-ref arr (- half 1)
)
)
 (else (list-ref arr (- half 1)
)
)
)
)
