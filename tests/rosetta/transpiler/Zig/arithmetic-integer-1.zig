...
fn mochi_main() void {
    ...
    _print(_concat_string(_concat_string(_concat_string(_concat_string(_str(a), " - "), _str(b)), " = "), _str(a - b)));
    _print(_concat_string(_concat_string(_concat_string(_concat_string(_str(a), " * "), _str(b)), " = "), _str(a * b)));
    _print(_concat_string(_concat_string(_concat_string(_concat_string(_str(a), " / "), _str(b)), " = "), _str(@divTrunc(a, b))));
    _print(_concat_string(_concat_string(_concat_string(_concat_string(_str(a), " % "), _str(b)), " = "), _str(@mod(a, b))));
}
