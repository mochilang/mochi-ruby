// Generated by Mochi v0.10.56 on 2025-08-04 00:18:27 GMT+7
...
def g2l(pieces: String): String = {
  ...
  while (i < BigInt(((pieces).size).toInt)) {
    ...
    res = res + g2lMap.getOrElse(ch, "").asInstanceOf[String]
    i = i + BigInt(1)
  }
  return res
}
...
def spid(_pieces: String): BigInt = {
  ...
  val N: BigInt = ntable.getOrElse(String.valueOf(n1) + String.valueOf(n2), null).asInstanceOf[BigInt]
