// Generated by Mochi v0.10.57 on 2025-08-04 16:35:28 GMT+7
...
def main(args: Array[String]): Unit = {
  {
    ...
    val _start = _now()
    var poss: ArrayBuffer[ArrayBuffer[BigInt]] = (ArrayBuffer()).asInstanceOf[ArrayBuffer[ArrayBuffer[BigInt]]]
    var y: BigInt = 0 - rMax
    while (y <= rMax) {
      var x: BigInt = 0 - rMax
      while (x <= rMax) {
    ...
    while (n < nPts) {
      ...
      var x: BigInt = poss((i.toInt).toInt)((0.toInt).toInt)
      val yy: BigInt = poss((i.toInt).toInt)((1.toInt).toInt)
    ...
    while (i2 < span) {
      ...
      var j: BigInt = 0
      while (j < span * 2) {
        line = line + rows((i2.toInt).toInt)((j.toInt).toInt)
        j = j + 1
      }
      println(line)
      i2 = i2 + 1
