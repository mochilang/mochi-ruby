// Generated by Mochi v0.10.52 on 2025-08-02 00:20:25 GMT+7
...
def main(): Any = {
  ...
  var hm: Double = 0.0
  for (ch <- counts.keys) {
    val c: Double = (counts(ch)).toString.toDouble
    hm = (hm + c * log2(c)).toString.toDouble
  }
  println(String.valueOf(log2(l) - hm / l))
}
