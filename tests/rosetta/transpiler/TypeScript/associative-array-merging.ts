// Generated by Mochi v0.10.42 on 2025-07-27 18:45:38 GMT+7
...
function main() {
  let base: Base = {"name": "Rocket Skates", "price": 12.75, "color": "yellow"};
  let update: Update = {"price": 15.25, "color": "red", "year": 1974};
