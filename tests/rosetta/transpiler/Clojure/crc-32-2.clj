...
(defn main []
  (binding [main_hex nil main_result nil main_s nil] (do (set! main_s "The quick brown fox jumps over the lazy dog") (set! main_result (crc32 main_s)) (set! main_hex (clojure.string/lower-case (toHex main_result))) (println main_hex))))
