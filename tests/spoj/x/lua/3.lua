  ...
  elseif type(v) == 'string' then
    ...
    do
      ...
      function is_substring(a, b)
        ...
        local i = 0
        while ((i + lb) <= la) do
          if (string.sub(a, (i + 1), (i + lb)) == b) then
            return 1
          end
          i = (i + 1)
        end
      ...
      function solve(lines)
        ...
        for _, line in ipairs(lines) do
          ...
          local cur = ""
          local i = 0
          while (i < _len(line)) do
            local ch = string.sub(line, (i + 1), (i + 1))
            if (ch == " ") then
      ...
      res[#res+1] = item
      return res
    end)(res, is_substring(a, b))
  end
  return res
end
sample_input = {"1010110010 10110", "1110111011 10011"}
for _, r in ipairs(solve(sample_input)) do
