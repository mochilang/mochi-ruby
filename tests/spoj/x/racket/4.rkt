...
(define (popTop stack)
  (let/ec _return (begin
(_return (if stack (if (hash? stack) (hash-ref stack (- (cond [(not stack) 0] [(string? stack) (string-length stack)] [(vector? stack) (vector-length stack)] [(hash? stack) (hash-count stack)] [(list? stack) (length stack)] [else 0]) 1) #f) (safe-index stack (int (- (cond [(not stack) 0] [(string? stack) (string-length stack)] [(vector? stack) (vector-length stack)] [(hash? stack) (hash-count stack)] [(list? stack) (length stack)] [else 0]) 1)))) #f))
))
)
(define (popStack stack)
  (let/ec _return (begin
(define newStack (vector))
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (- (cond [(not stack) 0] [(string? stack) (string-length stack)] [(vector? stack) (vector-length stack)] [(hash? stack) (hash-count stack)] [(list? stack) (length stack)] [else 0]) 1)]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (set! newStack (appendv (or newStack (vector)) (vector (if stack (if (hash? stack) (hash-ref stack i #f) (safe-index stack (int i))) #f))))
...
(define i 0)
(let/ec _break (let loop ()
  (if (let ([__l i] [__r (cond [(not expr) 0] [(string? expr) (string-length expr)] [(vector? expr) (vector-length expr)] [(hash? expr) (hash-count expr)] [(list? expr) (length expr)] [else 0])]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (define ch (if (hash? expr) (hash-ref expr i #f) (substring expr (int i) (+ (int i) 1))))
...
(if (string=? ch ")") (let ()
(let/ec _break (let loop ()
  (if (let ([__l (cond [(not stack) 0] [(string? stack) (string-length stack)] [(vector? stack) (vector-length stack)] [(hash? stack) (hash-count stack)] [(list? stack) (length stack)] [else 0])] [__r 0]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (begin
    (let/ec _cont
      (define top (popTop stack))
      (if (string=? top "(") (let ()
(set! stack (popStack stack))
(_break)
) (void))
      (set! out (string-append out top))
      (set! stack (popStack stack))
    )
    (loop)) (void))))
) (let ()
(define prec (precedence ch))
(let/ec _break (let loop ()
  (if (let ([__l (cond [(not stack) 0] [(string? stack) (string-length stack)] [(vector? stack) (vector-length stack)] [(hash? stack) (hash-count stack)] [(list? stack) (length stack)] [else 0])] [__r 0]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (begin
    (let/ec _cont
      (define top (popTop stack))
...
(_break)
      ...
      (define topPrec (precedence top))
      (if (or (let ([__l topPrec] [__r prec]) (cond [(and (number? __l) (number? __r)) (> __l __r)] [else (> (int __l) (int __r))])) (and (equal? topPrec prec) (not (string=? ch "^")))) (let ()
(set! out (string-append out top))
(set! stack (popStack stack))
) (let ()
(_break)
...
(let/ec _break (let loop ()
  (if (let ([__l i] [__r t]) (cond [(and (number? __l) (number? __r)) (< __l __r)] [else (< (int __l) (int __r))])) (begin
    (let/ec _cont
      (define expr (input))
      (displayln (to-string (toRPN expr)))
      (set! i (let ([__l i] [__r 1]) (if (and (string? __l) (string? __r)) (string-append __l __r) (+ __l __r))))
    )
    (loop)) (void))))
))
