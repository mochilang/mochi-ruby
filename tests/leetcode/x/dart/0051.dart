...
Future<void> main() async {
  ...
  for (var tc = 0; tc < t; tc++) { final n = int.parse(lines[idx++].trim()); final sols = solve(n); out.add(sols.length.toString()); for (var si = 0; si < sols.length; si++) { out.addAll(sols[si]); if (si + 1 < sols.length) out.add('-'); } if (tc + 1 < t) out.add('='); }
