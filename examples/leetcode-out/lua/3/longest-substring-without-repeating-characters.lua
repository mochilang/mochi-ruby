...
function test_example_1()
    if not (__eq(lengthOfLongestSubstring("abcabcbb"), 3)) then
        error("expect failed")
    end
end

function test_example_2()
    if not (__eq(lengthOfLongestSubstring("bbbbb"), 1)) then
        error("expect failed")
    end
end

function test_example_3()
    if not (__eq(lengthOfLongestSubstring("pwwkew"), 3)) then
        error("expect failed")
    end
end

function test_empty_string()
    if not (__eq(lengthOfLongestSubstring(""), 0)) then
        error("expect failed")
    end
end
