...
function test_example_1()
    if not (__eq(isPalindrome(121), true)) then
        error("expect failed")
    end
end

function test_example_2()
    if not (__eq(isPalindrome(-121), false)) then
        error("expect failed")
    end
end

function test_example_3()
    if not (__eq(isPalindrome(10), false)) then
        error("expect failed")
    end
end

function test_zero()
    if not (__eq(isPalindrome(0), true)) then
        error("expect failed")
    end
end
